...
/**
 * Generated listing class for 'cache_generator' table.
 *
 * @author  Morgan Brunot <brunot.morgan@gmail.com>
 *          Denis Roussel <denis.roussel@gmail.com>
 * @package propel.generator.Cungfoo.Listing.Base
 */
class BaseCacheGeneratorListing extends Listing
{
    /**
     * {@inheritdoc}
     */
    public function configure()
    {
        ...
        $this->addColumn(new Column\DateColumn('cached_at'));
