...
class RESTConnection
{
    ...
    static public $acceptedVerbs = array (self::GET, self::POST, self::PUT, self::DELETE, self::PATCH);
    ...
    public function __construct($serviceUrl = null, $serviceRequestHeader = array(), $serviceUser = null, $servicePassword = null)
    {
    ...
    public function request($ressourceUrl, $params = null, $verb = self::GET, $overridingVerb = null)
    {
        ...
        //echo $this->serviceUrl.$ressourceUrl."\n";
    ...
    protected function setCurlOpts (&$curlHandle, $ressourceUrl, $overridingVerb)
    {
        ...
        //curl_setopt($curlHandle, CURLOPT_STDERR, $mydebug);
