...
use Cungfoo\Form\Type\Base\BaseRegionRefType;
 ...
 */
class RegionRefType extends BaseRegionRefType
{
    ...
    {
        return array_merge(parent::getPaysOptions(), array('read_only' => true, 'attr' => array(
            'rel'   => "tooltip",
            'title' => "crud.tooltip.resalys",
        )));
    }
