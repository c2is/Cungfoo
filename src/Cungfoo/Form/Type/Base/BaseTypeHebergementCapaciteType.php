...
class BaseTypeHebergementCapaciteType extends AppAwareType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('sortable_rank', $this->getSortableRankType(), $this->getSortableRankOptions());$builder->add('type_hebergement_capaciteI18ns', 'translation_collection', array(
