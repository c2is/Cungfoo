...
class BasePaysType extends AppAwareType
{
    ...
    public function getSeoDescriptionOptions()
    {
        return array(
            'required' => false,
            'label' => 'pays_i18n.seo_description',
        );
    }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('image_detail_2', $this->getImageDetail2Type(), $this->getImageDetail2Options());$builder->add('paysI18ns', 'translation_collection', array(
