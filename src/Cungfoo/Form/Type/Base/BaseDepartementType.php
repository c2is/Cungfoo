...
class BaseDepartementType extends AppAwareType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('region_ref', 'model', array(
            'class' => '\Cungfoo\Model\RegionRef',
            'constraints' => array(
            ),
            'label' => 'departement.region_ref',
            'required' => false,
        ));
        ...
        $builder->add('image_detail_1_deleted', 'checkbox', array(
            ...
            'property_path' => false,
            'label' => 'departement.image_detail_1_deleted',
            'required' => false,
        ));
        ...
        $builder->add('image_detail_2_deleted', 'checkbox', array(
            ...
            'property_path' => false,
            'label' => 'departement.image_detail_2_deleted',
            'required' => false,
        ));
        ...
        $builder->add('departementI18ns', 'translation_collection', array(
            'i18n_class' => 'Cungfoo\Model\DepartementI18n',
            'languages' => array(
                0 => 'fr',
                1 => 'de',
            ),
            'label' => 'departement.departementI18ns',
            'columns' => array(
                'slug' => array(
                    'required' => false,
                    'label' => 'departement.slug',
                    'type' => 'text',
                    'constraints' => array(
                        new Assert\NotBlank(),
                    ),
                ...
                'introduction' => array(
                    'required' => false,
                    'label' => 'departement.introduction',
                    'type' => 'text',
                    'constraints' => array(
                    ),
                ),
                ...
                'active_locale' => array(
                    'required' => false,
                    'label' => 'departement.active_locale',
                    'type' => 'checkbox',
                    'constraints' => array(
                    ),
                ),
                ...
                'seo_description' => array(
                    'required' => false,
                    'label' => 'departement.seo_description',
                    'type' => 'textarea',
                    'constraints' => array(
                    ),
                ),
                ...
                'seo_keywords' => array(
                    'required' => false,
                    'label' => 'departement.seo_keywords',
                    'type' => 'textarea',
                    'constraints' => array(
                    ),
                ),
