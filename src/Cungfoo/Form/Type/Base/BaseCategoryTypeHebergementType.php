    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('category_type_hebergementI18ns', 'translation_collection', array(
            ...
            'columns' => array(
                ...
                'active_locale' => array(
                    'required' => false,
                    'label' => 'category_type_hebergement.active_locale',
                    'type' => 'checkbox',
                    'constraints' => array(
                    ),
                ),
                'seo_title' => array(
                    'required' => false,
                    'label' => 'category_type_hebergement.seo_title',
                    'type' => 'text',
                    'constraints' => array(
                    ),
                ),
                'seo_description' => array(
                    'required' => false,
                    'label' => 'category_type_hebergement.seo_description',
                    'type' => 'textarea',
                    'constraints' => array(
                    ),
                ),
                'seo_h1' => array(
                    'required' => false,
                    'label' => 'category_type_hebergement.seo_h1',
                    'type' => 'text',
                    'constraints' => array(
                    ),
                ),
                'seo_keywords' => array(
                    'required' => false,
                    'label' => 'category_type_hebergement.seo_keywords',
                    'type' => 'textarea',
                    'constraints' => array(
                    ),
                ),
