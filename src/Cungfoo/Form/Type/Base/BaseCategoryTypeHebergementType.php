...
class BaseCategoryTypeHebergementType extends AppAwareType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('sortable_rank', $this->getSortableRankType(), $this->getSortableRankOptions());$builder->add('category_type_hebergementI18ns', 'translation_collection', array(
