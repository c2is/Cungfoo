...
class BaseVilleType extends AppAwareType
{
    ...
    public function getSeoDescriptionOptions()
    {
        return array(
            'required' => false,
            'label' => 'ville_i18n.seo_description',
        );
    }
    ...
    public function getActiveLocaleOptions()
    {
        return array(
            'required' => false,
            'label' => 'ville_i18n.active_locale',
        );
    }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('region', $this->getRegionType(), $this->getRegionOptions());
        ...
        $builder->add('image_detail_2', $this->getImageDetail2Type(), $this->getImageDetail2Options());$builder->add('villeI18ns', 'translation_collection', array(
