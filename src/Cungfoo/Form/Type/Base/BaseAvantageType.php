...
class BaseAvantageType extends AppAwareType
{
    ...
    public function getSeoDescriptionOptions()
    {
        return array(
            'required' => false,
            'label' => 'avantage_i18n.seo_description',
        );
    }
    ...
    public function getSeoKeywordsOptions()
    {
        return array(
            'required' => false,
            'label' => 'avantage_i18n.seo_keywords',
        );
    }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('image_path', $this->getImagePathType(), $this->getImagePathOptions());$builder->add('avantageI18ns', 'translation_collection', array(
