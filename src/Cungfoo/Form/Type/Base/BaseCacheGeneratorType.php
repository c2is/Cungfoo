 ...
 */
class BaseCacheGeneratorType extends AppAwareType
{
    ...
    public function getCacheTimeType()
    {
        return 'integer';
    }
    ...
    public function getCachedAtType()
    {
        return 'datetime';
    }
    ...
    public function getCachedAtOptions()
    {
        return array(
            'required' => false,
            'label' => 'cache_generator.cached_at',
            'widget' => 'single_text',
        );
    }
    ...
    public function getCreatedAtOptions()
    {
        return array(
            'required' => false,
            'label' => 'cache_generator.created_at',
            'widget' => 'single_text',
        );
    }
    ...
    public function getUpdatedAtOptions()
    {
        return array(
            'required' => false,
            'label' => 'cache_generator.updated_at',
            'widget' => 'single_text',
        );
    }
    ...
    public function getSeoTitleOptions()
    {
        return array(
            'required' => false,
            'label' => 'cache_generator_i18n.seo_title',
        );
    }
    ...
    public function getSeoDescriptionOptions()
    {
        return array(
            'required' => false,
            'label' => 'cache_generator_i18n.seo_description',
        );
    }
    ...
    public function getSeoH1Options()
    {
        return array(
            'required' => false,
            'label' => 'cache_generator_i18n.seo_h1',
        );
    }
    ...
    public function getSeoKeywordsOptions()
    {
        return array(
            'required' => false,
            'label' => 'cache_generator_i18n.seo_keywords',
        );
    }
    ...
    public function getActiveLocaleOptions()
    {
        return array(
            'required' => false,
            'label' => 'cache_generator_i18n.active_locale',
        );
    }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('url', $this->getUrlType(), $this->getUrlOptions());
        $builder->add('cache_time', $this->getCacheTimeType(), $this->getCacheTimeOptions());
        $builder->add('cached_at', $this->getCachedAtType(), $this->getCachedAtOptions());
        ...
        $builder->add('active', $this->getActiveType(), $this->getActiveOptions());$builder->add('cache_generatorI18ns', 'translation_collection', array(
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Cungfoo\Model\CacheGenerator',
        ));
    }
