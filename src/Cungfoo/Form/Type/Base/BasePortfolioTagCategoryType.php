...
/**
 * Test class for Additional builder enabled on the 'portfolio_tag_category' table.
 *
 * @author  Morgan Brunot <brunot.morgan@gmail.com>
 *          Denis Roussel <denis.roussel@gmail.com>
 * @package propel.generator.Cungfoo.Form.Type.Base
 */
class BasePortfolioTagCategoryType extends AppAwareType
{
    ...
    public function getIdOptions()
    {
        return array(
            'required' => false,
            'label' => 'portfolio_tag_category.id',
        );
    }
    ...
    public function getNameOptions()
    {
        return array(
            'required' => false,
            'label' => 'portfolio_tag_category.name',
        );
    }
    ...
    public function getSlugOptions()
    {
        return array(
            'required' => false,
            'label' => 'portfolio_tag_category.slug',
        );
    }
    ...
    public function getSeoTitleOptions()
    {
        return array(
            'required' => false,
            'label' => 'portfolio_tag_category_i18n.seo_title',
        );
    }
    ...
    public function getSeoDescriptionOptions()
    {
        return array(
            'required' => false,
            'label' => 'portfolio_tag_category_i18n.seo_description',
        );
    }
    ...
    public function getSeoH1Options()
    {
        return array(
            'required' => false,
            'label' => 'portfolio_tag_category_i18n.seo_h1',
        );
    }
    ...
    public function getSeoKeywordsOptions()
    {
        return array(
            'required' => false,
            'label' => 'portfolio_tag_category_i18n.seo_keywords',
        );
    }
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Cungfoo\Model\PortfolioTagCategory',
        ));
    }
