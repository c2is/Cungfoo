...
abstract class BaseVillePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Code', 'RegionId', 'ImageDetail1', 'ImageDetail2', 'CreatedAt', 'UpdatedAt', 'Active', 'Enabled', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'code', 'regionId', 'imageDetail1', 'imageDetail2', 'createdAt', 'updatedAt', 'active', 'enabled', ),
        BasePeer::TYPE_COLNAME => array (VillePeer::ID, VillePeer::CODE, VillePeer::REGION_ID, VillePeer::IMAGE_DETAIL_1, VillePeer::IMAGE_DETAIL_2, VillePeer::CREATED_AT, VillePeer::UPDATED_AT, VillePeer::ACTIVE, VillePeer::ENABLED, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CODE', 'REGION_ID', 'IMAGE_DETAIL_1', 'IMAGE_DETAIL_2', 'CREATED_AT', 'UPDATED_AT', 'ACTIVE', 'ENABLED', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'code', 'region_id', 'image_detail_1', 'image_detail_2', 'created_at', 'updated_at', 'active', 'enabled', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Code' => 1, 'RegionId' => 2, 'ImageDetail1' => 3, 'ImageDetail2' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, 'Active' => 7, 'Enabled' => 8, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'code' => 1, 'regionId' => 2, 'imageDetail1' => 3, 'imageDetail2' => 4, 'createdAt' => 5, 'updatedAt' => 6, 'active' => 7, 'enabled' => 8, ),
        BasePeer::TYPE_COLNAME => array (VillePeer::ID => 0, VillePeer::CODE => 1, VillePeer::REGION_ID => 2, VillePeer::IMAGE_DETAIL_1 => 3, VillePeer::IMAGE_DETAIL_2 => 4, VillePeer::CREATED_AT => 5, VillePeer::UPDATED_AT => 6, VillePeer::ACTIVE => 7, VillePeer::ENABLED => 8, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CODE' => 1, 'REGION_ID' => 2, 'IMAGE_DETAIL_1' => 3, 'IMAGE_DETAIL_2' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, 'ACTIVE' => 7, 'ENABLED' => 8, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'code' => 1, 'region_id' => 2, 'image_detail_1' => 3, 'image_detail_2' => 4, 'created_at' => 5, 'updated_at' => 6, 'active' => 7, 'enabled' => 8, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
