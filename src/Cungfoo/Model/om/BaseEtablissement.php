...
abstract class BaseEtablissement extends BaseObject implements Persistent
{
    ...
    public function getDestinationsActive($criteria = null, PropelPDO $con = null)
    {
        ...
        $criteria->addJoin(\Cungfoo\Model\DestinationPeer::ID, \Cungfoo\Model\DestinationI18nPeer::ID, \Criteria::LEFT_JOIN);
        $criteria->add(\Cungfoo\Model\DestinationI18nPeer::ACTIVE_LOCALE, true);
        $criteria->add(\Cungfoo\Model\DestinationI18nPeer::LOCALE, $this->currentLocale);
    ...
    public function getSituationGeographiquesActive($criteria = null, PropelPDO $con = null)
    {
        ...
        $criteria->addJoin(\Cungfoo\Model\SituationGeographiquePeer::ID, \Cungfoo\Model\SituationGeographiqueI18nPeer::ID, \Criteria::LEFT_JOIN);
        $criteria->add(\Cungfoo\Model\SituationGeographiqueI18nPeer::ACTIVE_LOCALE, true);
        $criteria->add(\Cungfoo\Model\SituationGeographiqueI18nPeer::LOCALE, $this->currentLocale);
    ...
    public function getThematiquesActive($criteria = null, PropelPDO $con = null)
    {
        ...
        $criteria->addJoin(\Cungfoo\Model\ThematiquePeer::ID, \Cungfoo\Model\ThematiqueI18nPeer::ID, \Criteria::LEFT_JOIN);
        $criteria->add(\Cungfoo\Model\ThematiqueI18nPeer::ACTIVE_LOCALE, true);
        $criteria->add(\Cungfoo\Model\ThematiqueI18nPeer::LOCALE, $this->currentLocale);
    ...
    public function getPointInteretsActive($criteria = null, PropelPDO $con = null)
    {
        ...
        $criteria->addJoin(\Cungfoo\Model\PointInteretPeer::ID, \Cungfoo\Model\PointInteretI18nPeer::ID, \Criteria::LEFT_JOIN);
        $criteria->add(\Cungfoo\Model\PointInteretI18nPeer::ACTIVE_LOCALE, true);
        $criteria->add(\Cungfoo\Model\PointInteretI18nPeer::LOCALE, $this->currentLocale);
    ...
    public function getEventsActive($criteria = null, PropelPDO $con = null)
    {
        ...
        $criteria->addJoin(\Cungfoo\Model\EventPeer::ID, \Cungfoo\Model\EventI18nPeer::ID, \Criteria::LEFT_JOIN);
        $criteria->add(\Cungfoo\Model\EventI18nPeer::ACTIVE_LOCALE, true);
        $criteria->add(\Cungfoo\Model\EventI18nPeer::LOCALE, $this->currentLocale);
    ...
    public function getMultimediasActive($criteria = null, PropelPDO $con = null)
    {
        ...
        $criteria->addJoin(\Cungfoo\Model\MultimediaPeer::ID, \Cungfoo\Model\MultimediaI18nPeer::ID, \Criteria::LEFT_JOIN);
        $criteria->add(\Cungfoo\Model\MultimediaI18nPeer::ACTIVE_LOCALE, true);
        $criteria->add(\Cungfoo\Model\MultimediaI18nPeer::LOCALE, $this->currentLocale);
    ...
    public function getTopCampingsActive($criteria = null, PropelPDO $con = null)
    {
        ...
        $criteria->addJoin(\Cungfoo\Model\TopCampingPeer::ID, \Cungfoo\Model\TopCampingI18nPeer::ID, \Criteria::LEFT_JOIN);
        $criteria->add(\Cungfoo\Model\TopCampingI18nPeer::ACTIVE_LOCALE, true);
        $criteria->add(\Cungfoo\Model\TopCampingI18nPeer::LOCALE, $this->currentLocale);
    ...
    public function getDemandeAnnulationsActive($criteria = null, PropelPDO $con = null)
    {
        ...
        $criteria->addJoin(\Cungfoo\Model\DemandeAnnulationPeer::ID, \Cungfoo\Model\DemandeAnnulationI18nPeer::ID, \Criteria::LEFT_JOIN);
        $criteria->add(\Cungfoo\Model\DemandeAnnulationI18nPeer::ACTIVE_LOCALE, true);
        $criteria->add(\Cungfoo\Model\DemandeAnnulationI18nPeer::LOCALE, $this->currentLocale);
