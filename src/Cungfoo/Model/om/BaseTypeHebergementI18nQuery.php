...
abstract class BaseTypeHebergementI18nQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `locale`, `name`, `slug`, `indice`, `surface`, `type_terrasse`, `description`, `composition`, `presentation`, `capacite_hebergement`, `dimensions`, `agencement`, `equipements`, `annee_utilisation`, `remarque_1`, `remarque_2`, `remarque_3`, `remarque_4`, `seo_title`, `seo_description`, `seo_h1`, `seo_keywords`, `active_locale` FROM `type_hebergement_i18n` WHERE `id` = :p0 AND `locale` = :p1';
        try {
