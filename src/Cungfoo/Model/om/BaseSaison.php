...
abstract class BaseSaison extends BaseObject implements Persistent
{
     ...
     * If this Saison is new, it will return
     ...
     * @return PropelObjectCollection|Camping[] List of Camping objects
     */
    public function getCampingsJoinSite($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CampingQuery::create(null, $criteria);
