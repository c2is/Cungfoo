 ...
 */
abstract class BaseEtablissementDestination extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\EtablissementDestinationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EtablissementDestinationPeer
     */
    ...
    public function setEtablissementId($v)
    {
        ...
        if ($this->etablissement_id !== $v) {
            ...
            $this->modifiedColumns[] = EtablissementDestinationPeer::ETABLISSEMENT_ID;
        }
    ...
    public function setDestinationId($v)
    {
        ...
        if ($this->destination_id !== $v) {
            ...
            $this->modifiedColumns[] = EtablissementDestinationPeer::DESTINATION_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            throw new PropelException("Error populating EtablissementDestination object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EtablissementDestinationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EtablissementDestinationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EtablissementDestinationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `etablissement_destination` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EtablissementDestinationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EtablissementDestinationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['EtablissementDestination'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EtablissementDestination'][serialize($this->getPrimaryKey())] = true;
        $keys = EtablissementDestinationPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EtablissementDestinationPeer::ETABLISSEMENT_ID)) $criteria->add(EtablissementDestinationPeer::ETABLISSEMENT_ID, $this->etablissement_id);
        if ($this->isColumnModified(EtablissementDestinationPeer::DESTINATION_ID)) $criteria->add(EtablissementDestinationPeer::DESTINATION_ID, $this->destination_id);
    ...
    {
        $criteria = new Criteria(EtablissementDestinationPeer::DATABASE_NAME);
        $criteria->add(EtablissementDestinationPeer::ETABLISSEMENT_ID, $this->etablissement_id);
        $criteria->add(EtablissementDestinationPeer::DESTINATION_ID, $this->destination_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getEtablissementId()) && (null === $this->getDestinationId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of EtablissementDestination (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EtablissementDestination Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EtablissementDestinationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EtablissementDestinationPeer();
        }
    ...
    public function setEtablissement(Etablissement $v = null)
    {
        ...
        if ($v !== null) {
            $v->addEtablissementDestination($this);
        }
    ...
    public function getEtablissement(PropelPDO $con = null)
    {
        if ($this->aEtablissement === null && ($this->etablissement_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEtablissement->addEtablissementDestinations($this);
             */
        }
    ...
    public function getDestination(PropelPDO $con = null)
    {
        if ($this->aDestination === null && ($this->destination_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDestination->addEtablissementDestinations($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(EtablissementDestinationPeer::DEFAULT_STRING_FORMAT);
    }
