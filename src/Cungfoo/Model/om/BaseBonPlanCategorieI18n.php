...
/**
 * Base class that represents a row from the 'bon_plan_categorie_i18n' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseBonPlanCategorieI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\BonPlanCategorieI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BonPlanCategorieI18nPeer
     */
    ...
    /**
     * Initializes internal state of BaseBonPlanCategorieI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BonPlanCategorieI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = BonPlanCategorieI18nPeer::LOCALE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = BonPlanCategorieI18nPeer::NAME;
        }
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = BonPlanCategorieI18nPeer::SLUG;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = BonPlanCategorieI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = BonPlanCategorieI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = BonPlanCategorieI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = BonPlanCategorieI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = BonPlanCategorieI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 11; // 11 = BonPlanCategorieI18nPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aBonPlanCategorie !== null && $this->id !== $this->aBonPlanCategorie->getId()) {
            $this->aBonPlanCategorie = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BonPlanCategorieI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BonPlanCategorieI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BonPlanCategorieI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::NAME)) {
        ...
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::ACTIVE_LOCALE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BonPlanCategorieI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BonPlanCategorieI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BonPlanCategorieI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BonPlanCategorieI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = BonPlanCategorieI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::ID)) $criteria->add(BonPlanCategorieI18nPeer::ID, $this->id);
        ...
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::SEO_TITLE)) $criteria->add(BonPlanCategorieI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::SEO_DESCRIPTION)) $criteria->add(BonPlanCategorieI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::SEO_H1)) $criteria->add(BonPlanCategorieI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::SEO_KEYWORDS)) $criteria->add(BonPlanCategorieI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
        if ($this->isColumnModified(BonPlanCategorieI18nPeer::ACTIVE_LOCALE)) $criteria->add(BonPlanCategorieI18nPeer::ACTIVE_LOCALE, $this->active_locale);
    ...
    {
        $criteria = new Criteria(BonPlanCategorieI18nPeer::DATABASE_NAME);
        $criteria->add(BonPlanCategorieI18nPeer::ID, $this->id);
        $criteria->add(BonPlanCategorieI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of BonPlanCategorieI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BonPlanCategorieI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BonPlanCategorieI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BonPlanCategorieI18nPeer();
        }
    ...
    public function setBonPlanCategorie(BonPlanCategorie $v = null)
    {
        ...
        if ($v !== null) {
            $v->addBonPlanCategorieI18n($this);
        }
    ...
    {
        if ($this->aBonPlanCategorie === null && ($this->id !== null) && $doQuery) {
            $this->aBonPlanCategorie = BonPlanCategorieQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBonPlanCategorie->addBonPlanCategorieI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BonPlanCategorieI18nPeer::DEFAULT_STRING_FORMAT);
    }
