 ...
 */
abstract class BaseBaignadeI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\BaignadeI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BaignadeI18nPeer
     */
    ...
    /**
     * Initializes internal state of BaseBaignadeI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BaignadeI18nPeer::ID;
        }

        if ($this->aBaignade !== null && $this->aBaignade->getId() !== $v) {
            $this->aBaignade = null;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = BaignadeI18nPeer::LOCALE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = BaignadeI18nPeer::NAME;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = BaignadeI18nPeer::DESCRIPTION;
        }
    ...
    public function setKeywords($v)
    {
        ...
        if ($this->keywords !== $v) {
            $this->keywords = $v;
            $this->modifiedColumns[] = BaignadeI18nPeer::KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = BaignadeI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = BaignadeI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = BaignadeI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = BaignadeI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = BaignadeI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = BaignadeI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BaignadeI18n object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aBaignade !== null && $this->id !== $this->aBaignade->getId()) {
            $this->aBaignade = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BaignadeI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BaignadeI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BaignadeI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aBaignade !== null) {
                if ($this->aBaignade->isModified() || $this->aBaignade->isNew()) {
                    $affectedRows += $this->aBaignade->save($con);
                }
                $this->setBaignade($this->aBaignade);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BaignadeI18nPeer::ACTIVE_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`active_locale`';
        }
        if ($this->isColumnModified(BaignadeI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(BaignadeI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(BaignadeI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(BaignadeI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }

        $sql = sprintf(
            'INSERT INTO `baignade_i18n` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aBaignade !== null) {
                if (!$this->aBaignade->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aBaignade->getValidationFailures());
                }
            }


            if (($retval = BaignadeI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BaignadeI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BaignadeI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BaignadeI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = BaignadeI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aBaignade) {
                $result['Baignade'] = $this->aBaignade->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BaignadeI18nPeer::ID)) $criteria->add(BaignadeI18nPeer::ID, $this->id);
        if ($this->isColumnModified(BaignadeI18nPeer::LOCALE)) $criteria->add(BaignadeI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(BaignadeI18nPeer::NAME)) $criteria->add(BaignadeI18nPeer::NAME, $this->name);
        if ($this->isColumnModified(BaignadeI18nPeer::DESCRIPTION)) $criteria->add(BaignadeI18nPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(BaignadeI18nPeer::KEYWORDS)) $criteria->add(BaignadeI18nPeer::KEYWORDS, $this->keywords);
        if ($this->isColumnModified(BaignadeI18nPeer::ACTIVE_LOCALE)) $criteria->add(BaignadeI18nPeer::ACTIVE_LOCALE, $this->active_locale);
        if ($this->isColumnModified(BaignadeI18nPeer::SEO_TITLE)) $criteria->add(BaignadeI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(BaignadeI18nPeer::SEO_DESCRIPTION)) $criteria->add(BaignadeI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(BaignadeI18nPeer::SEO_H1)) $criteria->add(BaignadeI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(BaignadeI18nPeer::SEO_KEYWORDS)) $criteria->add(BaignadeI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
    ...
    {
        $criteria = new Criteria(BaignadeI18nPeer::DATABASE_NAME);
        $criteria->add(BaignadeI18nPeer::ID, $this->id);
        $criteria->add(BaignadeI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of BaignadeI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BaignadeI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BaignadeI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BaignadeI18nPeer();
        }
    ...
    /**
     * Declares an association between this object and a Baignade object.
     *
     * @param             Baignade $v
     * @return BaignadeI18n The current object (for fluent API support)
     * @throws PropelException
     */
    public function setBaignade(Baignade $v = null)
    {
        if ($v === null) {
            $this->setId(NULL);
        } else {
        ...
        // If this object has already been added to the Baignade object, it will not be re-added.
        if ($v !== null) {
            $v->addBaignadeI18n($this);
        }
    ...
    public function getBaignade(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBaignade === null && ($this->id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBaignade->addBaignadeI18ns($this);
             */
        }

        return $this->aBaignade;
    }
    ...
    {
        return (string) $this->exportTo(BaignadeI18nPeer::DEFAULT_STRING_FORMAT);
    }
