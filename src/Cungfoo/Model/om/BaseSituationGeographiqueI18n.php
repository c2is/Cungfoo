 ...
 */
abstract class BaseSituationGeographiqueI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\SituationGeographiqueI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SituationGeographiqueI18nPeer
     */
    ...
    /**
     * Initializes internal state of BaseSituationGeographiqueI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SituationGeographiqueI18nPeer::ID;
        }

        if ($this->aSituationGeographique !== null && $this->aSituationGeographique->getId() !== $v) {
            $this->aSituationGeographique = null;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = SituationGeographiqueI18nPeer::LOCALE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = SituationGeographiqueI18nPeer::NAME;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = SituationGeographiqueI18nPeer::DESCRIPTION;
        }
    ...
    public function setKeywords($v)
    {
        ...
        if ($this->keywords !== $v) {
            $this->keywords = $v;
            $this->modifiedColumns[] = SituationGeographiqueI18nPeer::KEYWORDS;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = SituationGeographiqueI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = SituationGeographiqueI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = SituationGeographiqueI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = SituationGeographiqueI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = SituationGeographiqueI18nPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aSituationGeographique !== null && $this->id !== $this->aSituationGeographique->getId()) {
            $this->aSituationGeographique = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SituationGeographiqueI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SituationGeographiqueI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SituationGeographiqueI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aSituationGeographique !== null) {
                if ($this->aSituationGeographique->isModified() || $this->aSituationGeographique->isNew()) {
                    $affectedRows += $this->aSituationGeographique->save($con);
                }
                $this->setSituationGeographique($this->aSituationGeographique);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`keywords`';
        }
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::SEO_KEYWORDS)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aSituationGeographique !== null) {
                if (!$this->aSituationGeographique->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aSituationGeographique->getValidationFailures());
                }
            }


            if (($retval = SituationGeographiqueI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SituationGeographiqueI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SituationGeographiqueI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SituationGeographiqueI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = SituationGeographiqueI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aSituationGeographique) {
                $result['SituationGeographique'] = $this->aSituationGeographique->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::ID)) $criteria->add(SituationGeographiqueI18nPeer::ID, $this->id);
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::LOCALE)) $criteria->add(SituationGeographiqueI18nPeer::LOCALE, $this->locale);
        ...
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::SEO_TITLE)) $criteria->add(SituationGeographiqueI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::SEO_DESCRIPTION)) $criteria->add(SituationGeographiqueI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::SEO_H1)) $criteria->add(SituationGeographiqueI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(SituationGeographiqueI18nPeer::SEO_KEYWORDS)) $criteria->add(SituationGeographiqueI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
    ...
    {
        $criteria = new Criteria(SituationGeographiqueI18nPeer::DATABASE_NAME);
        $criteria->add(SituationGeographiqueI18nPeer::ID, $this->id);
        $criteria->add(SituationGeographiqueI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of SituationGeographiqueI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SituationGeographiqueI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SituationGeographiqueI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SituationGeographiqueI18nPeer();
        }
    ...
    /**
     * Declares an association between this object and a SituationGeographique object.
     *
     * @param             SituationGeographique $v
     * @return SituationGeographiqueI18n The current object (for fluent API support)
     * @throws PropelException
     */
    public function setSituationGeographique(SituationGeographique $v = null)
    {
        if ($v === null) {
            $this->setId(NULL);
        } else {
        ...
        $this->aSituationGeographique = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the SituationGeographique object, it will not be re-added.
        if ($v !== null) {
            $v->addSituationGeographiqueI18n($this);
        }
    ...
    {
        if ($this->aSituationGeographique === null && ($this->id !== null) && $doQuery) {
            $this->aSituationGeographique = SituationGeographiqueQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSituationGeographique->addSituationGeographiqueI18ns($this);
             */
        }

        return $this->aSituationGeographique;
    }
    ...
    {
        return (string) $this->exportTo(SituationGeographiqueI18nPeer::DEFAULT_STRING_FORMAT);
    }
