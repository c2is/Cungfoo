...
abstract class BaseDocumentI18n extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\DocumentI18nPeer';
    ...
    public function setBody($v)
    {
        ...
        if ($this->body !== $v) {
            $this->body = $v;
            $this->modifiedColumns[] = DocumentI18nPeer::BODY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = DocumentI18nPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DocumentI18nPeer::BODY)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DocumentI18nPeer::BODY)) $criteria->add(DocumentI18nPeer::BODY, $this->body);
