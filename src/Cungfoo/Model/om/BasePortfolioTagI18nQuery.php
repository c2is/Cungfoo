...
/**
 * Base class that represents a query for the 'portfolio_tag_i18n' table.
 *
 *
 *
 ...
 * @method PortfolioTagI18nQuery orderBySeoKeywords($order = Criteria::ASC) Order by the seo_keywords column
 * @method PortfolioTagI18nQuery orderByActiveLocale($order = Criteria::ASC) Order by the active_locale column
 *
 ...
 * @method PortfolioTagI18nQuery groupBySeoKeywords() Group by the seo_keywords column
 * @method PortfolioTagI18nQuery groupByActiveLocale() Group by the active_locale column
 *
 * @method PortfolioTagI18nQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method PortfolioTagI18nQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method PortfolioTagI18nQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method PortfolioTagI18nQuery leftJoinPortfolioTag($relationAlias = null) Adds a LEFT JOIN clause to the query using the PortfolioTag relation
 * @method PortfolioTagI18nQuery rightJoinPortfolioTag($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PortfolioTag relation
 * @method PortfolioTagI18nQuery innerJoinPortfolioTag($relationAlias = null) Adds a INNER JOIN clause to the query using the PortfolioTag relation
 *
 * @method PortfolioTagI18n findOne(PropelPDO $con = null) Return the first PortfolioTagI18n matching the query
 * @method PortfolioTagI18n findOneOrCreate(PropelPDO $con = null) Return the first PortfolioTagI18n matching the query, or a new PortfolioTagI18n object populated from the query conditions when no match is found
 *
 ...
 * @method PortfolioTagI18n findOneBySeoKeywords(string $seo_keywords) Return the first PortfolioTagI18n filtered by the seo_keywords column
 * @method PortfolioTagI18n findOneByActiveLocale(boolean $active_locale) Return the first PortfolioTagI18n filtered by the active_locale column
 *
 ...
 * @method array findBySeoKeywords(string $seo_keywords) Return PortfolioTagI18n objects filtered by the seo_keywords column
 * @method array findByActiveLocale(boolean $active_locale) Return PortfolioTagI18n objects filtered by the active_locale column
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BasePortfolioTagI18nQuery extends ModelCriteria
{
    /**
     * Initializes internal state of BasePortfolioTagI18nQuery object.
     *
     * @param     string $dbName The dabase name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cungfoo', $modelName = 'Cungfoo\\Model\\PortfolioTagI18n', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new PortfolioTagI18nQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     PortfolioTagI18nQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return PortfolioTagI18nQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof PortfolioTagI18nQuery) {
            return $criteria;
        }
        $query = new PortfolioTagI18nQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return   PortfolioTagI18n|PortfolioTagI18n[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = PortfolioTagI18nPeer::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && !$this->formatter) {
     ...
     *
     * @return   PortfolioTagI18n A model object, or null if the key is not found
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new PortfolioTagI18n();
            $obj->hydrate($row);
            PortfolioTagI18nPeer::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|PortfolioTagI18n[]|mixed the list of results, formatted by the current formatter
     */
    ...
    {
        $this->addUsingAlias(PortfolioTagI18nPeer::ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(PortfolioTagI18nPeer::LOCALE, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(PortfolioTagI18nPeer::ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(PortfolioTagI18nPeer::LOCALE, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PortfolioTagI18nPeer::ID, $id, $comparison);
    }
    ...
    public function filterBySeoTitle($seoTitle = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PortfolioTagI18nPeer::SEO_TITLE, $seoTitle, $comparison);
    }
    ...
    public function filterBySeoDescription($seoDescription = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PortfolioTagI18nPeer::SEO_DESCRIPTION, $seoDescription, $comparison);
    }
    ...
    public function filterBySeoH1($seoH1 = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PortfolioTagI18nPeer::SEO_H1, $seoH1, $comparison);
    }
    ...
    public function filterBySeoKeywords($seoKeywords = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PortfolioTagI18nPeer::SEO_KEYWORDS, $seoKeywords, $comparison);
    }
    ...
    public function filterByActiveLocale($activeLocale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PortfolioTagI18nPeer::ACTIVE_LOCALE, $activeLocale, $comparison);
    }
    ...
    public function filterByPortfolioTag($portfolioTag, $comparison = null)
    {
        if ($portfolioTag instanceof PortfolioTag) {
            return $this
                ->addUsingAlias(PortfolioTagI18nPeer::ID, $portfolioTag->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PortfolioTagI18nPeer::ID, $portfolioTag->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     * @return PortfolioTagI18nQuery The current query, for fluid interface
     */
    public function joinPortfolioTag($relationAlias = null, $joinType = 'LEFT JOIN')
    {
     ...
     */
    public function usePortfolioTagQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
     ...
     *
     * @param   PortfolioTagI18n $portfolioTagI18n Object to remove from the list of results
     *
     * @return PortfolioTagI18nQuery The current query, for fluid interface
     */
    public function prune($portfolioTagI18n = null)
    {
        if ($portfolioTagI18n) {
            $this->addCond('pruneCond0', $this->getAliasedColName(PortfolioTagI18nPeer::ID), $portfolioTagI18n->getId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(PortfolioTagI18nPeer::LOCALE), $portfolioTagI18n->getLocale(), Criteria::NOT_EQUAL);
