...
abstract class BaseEtablissementPeer
{
    ...
    const COUNTRY = 'etablissement.COUNTRY';
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (EtablissementPeer::ID => 0, EtablissementPeer::NAME => 1, EtablissementPeer::ADDRESS1 => 2, EtablissementPeer::ADDRESS2 => 3, EtablissementPeer::ZIP => 4, EtablissementPeer::CITY => 5, EtablissementPeer::MAIL => 6, EtablissementPeer::COUNTRY => 7, EtablissementPeer::COUNTRY_CODE => 8, EtablissementPeer::PHONE1 => 9, EtablissementPeer::PHONE2 => 10, EtablissementPeer::FAX => 11, EtablissementPeer::VILLE_ID => 12, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(EtablissementPeer::COUNTRY);
