...
use Cungfoo\Model\map\VilleI18nTableMap;
...
abstract class BaseVilleI18nPeer
{
    ...
    const OM_CLASS = 'Cungfoo\\Model\\VilleI18n';
    ...
    const ACTIVE_LOCALE = 'ville_i18n.active_locale';

    /** the column name for the seo_title field */
    const SEO_TITLE = 'ville_i18n.seo_title';

    /** the column name for the seo_description field */
    const SEO_DESCRIPTION = 'ville_i18n.seo_description';

    /** the column name for the seo_h1 field */
    const SEO_H1 = 'ville_i18n.seo_h1';

    /** the column name for the seo_keywords field */
    const SEO_KEYWORDS = 'ville_i18n.seo_keywords';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of VilleI18n objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (VilleI18nPeer::ID, VilleI18nPeer::LOCALE, VilleI18nPeer::SLUG, VilleI18nPeer::NAME, VilleI18nPeer::INTRODUCTION, VilleI18nPeer::DESCRIPTION, VilleI18nPeer::ACTIVE_LOCALE, VilleI18nPeer::SEO_TITLE, VilleI18nPeer::SEO_DESCRIPTION, VilleI18nPeer::SEO_H1, VilleI18nPeer::SEO_KEYWORDS, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (VilleI18nPeer::ID => 0, VilleI18nPeer::LOCALE => 1, VilleI18nPeer::SLUG => 2, VilleI18nPeer::NAME => 3, VilleI18nPeer::INTRODUCTION => 4, VilleI18nPeer::DESCRIPTION => 5, VilleI18nPeer::ACTIVE_LOCALE => 6, VilleI18nPeer::SEO_TITLE => 7, VilleI18nPeer::SEO_DESCRIPTION => 8, VilleI18nPeer::SEO_H1 => 9, VilleI18nPeer::SEO_KEYWORDS => 10, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(VilleI18nPeer::ID);
            $criteria->addSelectColumn(VilleI18nPeer::LOCALE);
            $criteria->addSelectColumn(VilleI18nPeer::SLUG);
            ...
            $criteria->addSelectColumn(VilleI18nPeer::ACTIVE_LOCALE);
            $criteria->addSelectColumn(VilleI18nPeer::SEO_TITLE);
            $criteria->addSelectColumn(VilleI18nPeer::SEO_DESCRIPTION);
            $criteria->addSelectColumn(VilleI18nPeer::SEO_H1);
            $criteria->addSelectColumn(VilleI18nPeer::SEO_KEYWORDS);
        } else {
    ...
    public static function doCountJoinVille(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(VilleI18nPeer::ID, VillePeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of VilleI18n objects pre-filled with their Ville objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of VilleI18n objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    ...
    /**
     * Selects a collection of VilleI18n objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(VilleI18nPeer::ID);
            $value = $criteria->remove(VilleI18nPeer::ID);
            if ($value) {
                $selectCriteria->add(VilleI18nPeer::ID, $value, $comparison);
            } else {
    ...
    /**
     * Performs a DELETE on the database, given a VilleI18n or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or VilleI18n object or primary key or array of primary keys
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(VilleI18nPeer::ID, $value[0]);
    ...
    public static function retrieveByPK($id, $locale, PropelPDO $con = null) {
        ...
        $criteria = new Criteria(VilleI18nPeer::DATABASE_NAME);
        $criteria->add(VilleI18nPeer::ID, $id);
