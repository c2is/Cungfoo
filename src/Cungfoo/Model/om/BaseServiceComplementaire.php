 ...
 */
abstract class BaseServiceComplementaire extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\ServiceComplementairePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ServiceComplementairePeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ServiceComplementairePeer::ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = ServiceComplementairePeer::CODE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ServiceComplementairePeer::CREATED_AT;
            }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ServiceComplementairePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ServiceComplementaireQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ServiceComplementairePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                ServiceComplementairePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `service_complementaire` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ServiceComplementairePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ServiceComplementairePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ServiceComplementaire'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ServiceComplementaire'][$this->getPrimaryKey()] = true;
    ...
    {
        $criteria = new Criteria(ServiceComplementairePeer::DATABASE_NAME);
        $criteria->add(ServiceComplementairePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ServiceComplementaire (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ServiceComplementaire Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ServiceComplementairePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ServiceComplementairePeer();
        }
    ...
    {
        return (string) $this->exportTo(ServiceComplementairePeer::DEFAULT_STRING_FORMAT);
    }
