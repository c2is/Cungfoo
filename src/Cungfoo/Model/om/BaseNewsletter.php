...
abstract class BaseNewsletter extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\NewsletterPeer';
    ...
    /**
     * @var        PropelObjectCollection|NewsletterI18n[] Collection to store aggregation of NewsletterI18n objects.
     */
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = NewsletterPeer::ACTIVE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = NewsletterPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NewsletterPeer::ACTIVE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewsletterPeer::ACTIVE)) $criteria->add(NewsletterPeer::ACTIVE, $this->active);
    ...
    public function clearNewsletterI18ns()
    {
        ...
        $this->collNewsletterI18nsPartial = null;
    ...
    public function initNewsletterI18ns($overrideExisting = true)
    {
        ...
        $this->collNewsletterI18ns = new PropelObjectCollection();
        $this->collNewsletterI18ns->setModel('NewsletterI18n');
    }

    /**
     * Gets an array of NewsletterI18n objects which contain a foreign key that references this object.
     *
     ...
     * @return PropelObjectCollection|NewsletterI18n[] List of NewsletterI18n objects
     * @throws PropelException
     */
    public function getNewsletterI18ns($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collNewsletterI18ns || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collNewsletterI18ns) {
                ...
                $collNewsletterI18ns = NewsletterI18nQuery::create(null, $criteria)
     ...
     *
     * @param PropelCollection $newsletterI18ns A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return Newsletter The current object (for fluent API support)
     */
    public function setNewsletterI18ns(PropelCollection $newsletterI18ns, PropelPDO $con = null)
    {
        $this->newsletterI18nsScheduledForDeletion = $this->getNewsletterI18ns(new Criteria(), $con)->diff($newsletterI18ns);

        foreach ($this->newsletterI18nsScheduledForDeletion as $newsletterI18nRemoved) {
     ...
     * @throws PropelException
     */
    public function countNewsletterI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collNewsletterI18nsPartial && !$this->isNew();
        if (null === $this->collNewsletterI18ns || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collNewsletterI18ns) {
            ...
            $query = NewsletterI18nQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a NewsletterI18n object to this object
     * through the NewsletterI18n foreign key attribute.
     *
     * @param    NewsletterI18n $l NewsletterI18n
     * @return Newsletter The current object (for fluent API support)
     */
    public function addNewsletterI18n(NewsletterI18n $l)
    {
    ...
    public function removeNewsletterI18n($newsletterI18n)
    {
        if ($this->getNewsletterI18ns()->contains($newsletterI18n)) {
            ...
            $this->newsletterI18nsScheduledForDeletion[]= $newsletterI18n;
    ...
    public function clearAllReferences($deep = false)
    {
        ...
        if ($this->collNewsletterI18ns instanceof PropelCollection) {
            $this->collNewsletterI18ns->clearIterator();
        }
        $this->collNewsletterI18ns = null;
    }
    ...
    public function getTranslation($locale = 'fr', PropelPDO $con = null)
    {
        if (!isset($this->currentTranslations[$locale])) {
            ...
            if ($this->isNew()) {
                $translation = new NewsletterI18n();
                $translation->setLocale($locale);
            } else {
                $translation = NewsletterI18nQuery::create()
