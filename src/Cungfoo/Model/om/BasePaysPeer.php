...
abstract class BasePaysPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PaysPeer::ID, PaysPeer::NAME, PaysPeer::CREATED_AT, PaysPeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PaysPeer::ID => 0, PaysPeer::NAME => 1, PaysPeer::CREATED_AT => 2, PaysPeer::UPDATED_AT => 3, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PaysPeer::NAME);
