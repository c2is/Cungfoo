...
abstract class BasePaysPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PaysPeer::ID, PaysPeer::CREATED_AT, PaysPeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PaysPeer::ID => 0, PaysPeer::CREATED_AT => 1, PaysPeer::UPDATED_AT => 2, ),
