...
use Cungfoo\Model\map\NavigationTableMap;
...
abstract class BaseNavigationPeer
{
    ...
    const OM_CLASS = 'Cungfoo\\Model\\Navigation';
    ...
    /**
     * An identiy map to hold any loaded instances of Navigation objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (NavigationPeer::ID, NavigationPeer::NAME, NavigationPeer::ACTIVE, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (NavigationPeer::ID => 0, NavigationPeer::NAME => 1, NavigationPeer::ACTIVE => 2, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NavigationPeer::ACTIVE);
        } else {
    ...
    public static function clearRelatedInstancePool()
    {
        ...
        // Invalidate objects in NavigationI18nPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
    ...
    public static function getMetadata($locale = 'fr', PropelPDO $con = null)
    {
        return \Cungfoo\Model\MetadataQuery::create()
            ->joinWithI18n($locale)
            ->filterByTableRef(NavigationPeer::TABLE_NAME)
            ->findOne()
        ;
    }
    // seo behavior
