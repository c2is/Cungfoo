...
/**
 * Base class that represents a row from the 'bon_plan_etablissement' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseBonPlanEtablissement extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\BonPlanEtablissementPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BonPlanEtablissementPeer
     */
     ...
     * @return BonPlanEtablissement The current object (for fluent API support)
     */
    public function setBonPlanId($v)
    {
        ...
        if ($this->bon_plan_id !== $v) {
            $this->bon_plan_id = $v;
            $this->modifiedColumns[] = BonPlanEtablissementPeer::BON_PLAN_ID;
        }
    ...
    public function setEtablissementId($v)
    {
        ...
        if ($this->etablissement_id !== $v) {
            ...
            $this->modifiedColumns[] = BonPlanEtablissementPeer::ETABLISSEMENT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = BonPlanEtablissementPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BonPlanEtablissement object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BonPlanEtablissementPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BonPlanEtablissementQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BonPlanEtablissementPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BonPlanEtablissementPeer::BON_PLAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bon_plan_id`';
        }
        if ($this->isColumnModified(BonPlanEtablissementPeer::ETABLISSEMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`etablissement_id`';
        }

        $sql = sprintf(
            'INSERT INTO `bon_plan_etablissement` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BonPlanEtablissementPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BonPlanEtablissementPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BonPlanEtablissement'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BonPlanEtablissement'][serialize($this->getPrimaryKey())] = true;
        $keys = BonPlanEtablissementPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BonPlanEtablissementPeer::BON_PLAN_ID)) $criteria->add(BonPlanEtablissementPeer::BON_PLAN_ID, $this->bon_plan_id);
        if ($this->isColumnModified(BonPlanEtablissementPeer::ETABLISSEMENT_ID)) $criteria->add(BonPlanEtablissementPeer::ETABLISSEMENT_ID, $this->etablissement_id);
    ...
    {
        $criteria = new Criteria(BonPlanEtablissementPeer::DATABASE_NAME);
        $criteria->add(BonPlanEtablissementPeer::BON_PLAN_ID, $this->bon_plan_id);
        $criteria->add(BonPlanEtablissementPeer::ETABLISSEMENT_ID, $this->etablissement_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getBonPlanId()) && (null === $this->getEtablissementId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of BonPlanEtablissement (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BonPlanEtablissement Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BonPlanEtablissementPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BonPlanEtablissementPeer();
        }
    ...
    public function setBonPlan(BonPlan $v = null)
    {
        ...
        if ($v !== null) {
            $v->addBonPlanEtablissement($this);
        }
    ...
    public function getBonPlan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBonPlan === null && ($this->bon_plan_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBonPlan->addBonPlanEtablissements($this);
             */
        }
    ...
    public function getEtablissement(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEtablissement === null && ($this->etablissement_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEtablissement->addBonPlanEtablissements($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BonPlanEtablissementPeer::DEFAULT_STRING_FORMAT);
    }
