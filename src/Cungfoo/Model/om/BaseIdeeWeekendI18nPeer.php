...
abstract class BaseIdeeWeekendI18nPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Locale', 'Titre', 'Lien', 'ActiveLocale', 'SeoTitle', 'SeoDescription', 'SeoH1', 'SeoKeywords', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'locale', 'titre', 'lien', 'activeLocale', 'seoTitle', 'seoDescription', 'seoH1', 'seoKeywords', ),
        BasePeer::TYPE_COLNAME => array (IdeeWeekendI18nPeer::ID, IdeeWeekendI18nPeer::LOCALE, IdeeWeekendI18nPeer::TITRE, IdeeWeekendI18nPeer::LIEN, IdeeWeekendI18nPeer::ACTIVE_LOCALE, IdeeWeekendI18nPeer::SEO_TITLE, IdeeWeekendI18nPeer::SEO_DESCRIPTION, IdeeWeekendI18nPeer::SEO_H1, IdeeWeekendI18nPeer::SEO_KEYWORDS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'LOCALE', 'TITRE', 'LIEN', 'ACTIVE_LOCALE', 'SEO_TITLE', 'SEO_DESCRIPTION', 'SEO_H1', 'SEO_KEYWORDS', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'locale', 'titre', 'lien', 'active_locale', 'seo_title', 'seo_description', 'seo_h1', 'seo_keywords', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Locale' => 1, 'Titre' => 2, 'Lien' => 3, 'ActiveLocale' => 4, 'SeoTitle' => 5, 'SeoDescription' => 6, 'SeoH1' => 7, 'SeoKeywords' => 8, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'locale' => 1, 'titre' => 2, 'lien' => 3, 'activeLocale' => 4, 'seoTitle' => 5, 'seoDescription' => 6, 'seoH1' => 7, 'seoKeywords' => 8, ),
        BasePeer::TYPE_COLNAME => array (IdeeWeekendI18nPeer::ID => 0, IdeeWeekendI18nPeer::LOCALE => 1, IdeeWeekendI18nPeer::TITRE => 2, IdeeWeekendI18nPeer::LIEN => 3, IdeeWeekendI18nPeer::ACTIVE_LOCALE => 4, IdeeWeekendI18nPeer::SEO_TITLE => 5, IdeeWeekendI18nPeer::SEO_DESCRIPTION => 6, IdeeWeekendI18nPeer::SEO_H1 => 7, IdeeWeekendI18nPeer::SEO_KEYWORDS => 8, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'LOCALE' => 1, 'TITRE' => 2, 'LIEN' => 3, 'ACTIVE_LOCALE' => 4, 'SEO_TITLE' => 5, 'SEO_DESCRIPTION' => 6, 'SEO_H1' => 7, 'SEO_KEYWORDS' => 8, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'locale' => 1, 'titre' => 2, 'lien' => 3, 'active_locale' => 4, 'seo_title' => 5, 'seo_description' => 6, 'seo_h1' => 7, 'seo_keywords' => 8, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
