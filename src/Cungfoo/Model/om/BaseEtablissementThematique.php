 ...
 */
abstract class BaseEtablissementThematique extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\EtablissementThematiquePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EtablissementThematiquePeer
     */
    ...
    /**
     * The value for the thematique_id field.
     * @var        int
     */
    ...
    public function setEtablissementId($v)
    {
        ...
        if ($this->etablissement_id !== $v) {
            ...
            $this->modifiedColumns[] = EtablissementThematiquePeer::ETABLISSEMENT_ID;
        }
     ...
     * @return EtablissementThematique The current object (for fluent API support)
     */
    public function setThematiqueId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->thematique_id !== $v) {
            $this->thematique_id = $v;
            $this->modifiedColumns[] = EtablissementThematiquePeer::THEMATIQUE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->thematique_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            throw new PropelException("Error populating EtablissementThematique object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aThematique !== null && $this->thematique_id !== $this->aThematique->getId()) {
            $this->aThematique = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EtablissementThematiquePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EtablissementThematiqueQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EtablissementThematiquePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `etablissement_thematique` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EtablissementThematiquePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EtablissementThematiquePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['EtablissementThematique'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EtablissementThematique'][serialize($this->getPrimaryKey())] = true;
        $keys = EtablissementThematiquePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getEtablissementId(),
            $keys[1] => $this->getThematiqueId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setThematiqueId($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EtablissementThematiquePeer::ETABLISSEMENT_ID)) $criteria->add(EtablissementThematiquePeer::ETABLISSEMENT_ID, $this->etablissement_id);
        if ($this->isColumnModified(EtablissementThematiquePeer::THEMATIQUE_ID)) $criteria->add(EtablissementThematiquePeer::THEMATIQUE_ID, $this->thematique_id);
    ...
    {
        $criteria = new Criteria(EtablissementThematiquePeer::DATABASE_NAME);
        $criteria->add(EtablissementThematiquePeer::ETABLISSEMENT_ID, $this->etablissement_id);
        $criteria->add(EtablissementThematiquePeer::THEMATIQUE_ID, $this->thematique_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getEtablissementId()) && (null === $this->getThematiqueId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of EtablissementThematique (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setThematiqueId($this->getThematiqueId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EtablissementThematique Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EtablissementThematiquePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EtablissementThematiquePeer();
        }
    ...
    public function setEtablissement(Etablissement $v = null)
    {
        ...
        if ($v !== null) {
            $v->addEtablissementThematique($this);
        }
    ...
    public function getEtablissement(PropelPDO $con = null)
    {
        if ($this->aEtablissement === null && ($this->etablissement_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEtablissement->addEtablissementThematiques($this);
             */
        }
    ...
    {
        if ($v === null) {
            $this->setThematiqueId(NULL);
        } else {
            $this->setThematiqueId($v->getId());
        }
    ...
    public function getThematique(PropelPDO $con = null)
    {
        if ($this->aThematique === null && ($this->thematique_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aThematique->addEtablissementThematiques($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(EtablissementThematiquePeer::DEFAULT_STRING_FORMAT);
    }
