...
abstract class BasePaysI18nQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `locale`, `slug`, `name`, `introduction`, `description`, `seo_title`, `seo_description`, `seo_h1`, `seo_keywords`, `active_locale` FROM `pays_i18n` WHERE `id` = :p0 AND `locale` = :p1';
        try {
