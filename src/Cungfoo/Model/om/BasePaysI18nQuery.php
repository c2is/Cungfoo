 ...
 * @method PaysI18nQuery orderByActiveLocale($order = Criteria::ASC) Order by the active_locale column
 * @method PaysI18nQuery orderBySeoTitle($order = Criteria::ASC) Order by the seo_title column
 * @method PaysI18nQuery orderBySeoDescription($order = Criteria::ASC) Order by the seo_description column
 * @method PaysI18nQuery orderBySeoH1($order = Criteria::ASC) Order by the seo_h1 column
 * @method PaysI18nQuery orderBySeoKeywords($order = Criteria::ASC) Order by the seo_keywords column
 *
 ...
 * @method PaysI18nQuery groupByActiveLocale() Group by the active_locale column
 * @method PaysI18nQuery groupBySeoTitle() Group by the seo_title column
 * @method PaysI18nQuery groupBySeoDescription() Group by the seo_description column
 * @method PaysI18nQuery groupBySeoH1() Group by the seo_h1 column
 * @method PaysI18nQuery groupBySeoKeywords() Group by the seo_keywords column
 *
 ...
 * @method PaysI18n findOneByActiveLocale(boolean $active_locale) Return the first PaysI18n filtered by the active_locale column
 * @method PaysI18n findOneBySeoTitle(string $seo_title) Return the first PaysI18n filtered by the seo_title column
 * @method PaysI18n findOneBySeoDescription(string $seo_description) Return the first PaysI18n filtered by the seo_description column
 * @method PaysI18n findOneBySeoH1(string $seo_h1) Return the first PaysI18n filtered by the seo_h1 column
 * @method PaysI18n findOneBySeoKeywords(string $seo_keywords) Return the first PaysI18n filtered by the seo_keywords column
 *
 ...
 * @method array findByActiveLocale(boolean $active_locale) Return PaysI18n objects filtered by the active_locale column
 * @method array findBySeoTitle(string $seo_title) Return PaysI18n objects filtered by the seo_title column
 * @method array findBySeoDescription(string $seo_description) Return PaysI18n objects filtered by the seo_description column
 * @method array findBySeoH1(string $seo_h1) Return PaysI18n objects filtered by the seo_h1 column
 * @method array findBySeoKeywords(string $seo_keywords) Return PaysI18n objects filtered by the seo_keywords column
 *
...
abstract class BasePaysI18nQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `locale`, `slug`, `name`, `introduction`, `description`, `active_locale`, `seo_title`, `seo_description`, `seo_h1`, `seo_keywords` FROM `pays_i18n` WHERE `id` = :p0 AND `locale` = :p1';
        try {
    ...
    public function filterByActiveLocale($activeLocale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PaysI18nPeer::ACTIVE_LOCALE, $activeLocale, $comparison);
    }
    ...
    public function filterBySeoTitle($seoTitle = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PaysI18nPeer::SEO_TITLE, $seoTitle, $comparison);
    }
    ...
    public function filterBySeoDescription($seoDescription = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PaysI18nPeer::SEO_DESCRIPTION, $seoDescription, $comparison);
    }
    ...
    public function filterBySeoH1($seoH1 = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PaysI18nPeer::SEO_H1, $seoH1, $comparison);
    }
    ...
    public function filterBySeoKeywords($seoKeywords = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PaysI18nPeer::SEO_KEYWORDS, $seoKeywords, $comparison);
    }
