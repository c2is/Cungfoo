 ...
 *
 * @method PaysI18n findOneById(string $id) Return the first PaysI18n filtered by the id column
 ...
 *
 * @method array findById(string $id) Return PaysI18n objects filtered by the id column
