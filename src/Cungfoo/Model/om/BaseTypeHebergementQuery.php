...
abstract class BaseTypeHebergementQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `code`, `category_type_hebergement_id`, `nombre_chambre`, `nombre_place`, `created_at`, `updated_at`, `active` FROM `type_hebergement` WHERE `id` = :p0';
        try {
    ...
    public function filterByTypeHebergementTypeHebergementCapacite($typeHebergementTypeHebergementCapacite, $comparison = null)
    {
        if ($typeHebergementTypeHebergementCapacite instanceof TypeHebergementTypeHebergementCapacite) {
            return $this
                ->addUsingAlias(TypeHebergementPeer::ID, $typeHebergementTypeHebergementCapacite->getTypeHebergementId(), $comparison);
     ...
     *
     * @param   TypeHebergementCapacite $typeHebergementCapacite the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   TypeHebergementQuery The current query, for fluid interface
     */
    public function filterByTypeHebergementCapacite($typeHebergementCapacite, $comparison = Criteria::EQUAL)
    {
        return $this
            ->useTypeHebergementTypeHebergementCapaciteQuery()
