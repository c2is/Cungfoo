 ...
 */
abstract class BaseVosVacancesI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\VosVacancesI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VosVacancesI18nPeer
     */
    ...
    /**
     * Initializes internal state of BaseVosVacancesI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = VosVacancesI18nPeer::ID;
        }

        if ($this->aVosVacances !== null && $this->aVosVacances->getId() !== $v) {
            $this->aVosVacances = null;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = VosVacancesI18nPeer::LOCALE;
        }
    ...
    public function setTitre($v)
    {
        ...
        if ($this->titre !== $v) {
            $this->titre = $v;
            $this->modifiedColumns[] = VosVacancesI18nPeer::TITRE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = VosVacancesI18nPeer::DESCRIPTION;
        }
    ...
    public function setPrenom($v)
    {
        ...
        if ($this->prenom !== $v) {
            $this->prenom = $v;
            $this->modifiedColumns[] = VosVacancesI18nPeer::PRENOM;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = VosVacancesI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = VosVacancesI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = VosVacancesI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = VosVacancesI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = VosVacancesI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VosVacancesI18n object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aVosVacances !== null && $this->id !== $this->aVosVacances->getId()) {
            $this->aVosVacances = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VosVacancesI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VosVacancesI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VosVacancesI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aVosVacances !== null) {
                if ($this->aVosVacances->isModified() || $this->aVosVacances->isNew()) {
                    $affectedRows += $this->aVosVacances->save($con);
                }
                $this->setVosVacances($this->aVosVacances);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VosVacancesI18nPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(VosVacancesI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(VosVacancesI18nPeer::TITRE)) {
            $modifiedColumns[':p' . $index++]  = '`titre`';
        }
        if ($this->isColumnModified(VosVacancesI18nPeer::DESCRIPTION)) {
        ...
        if ($this->isColumnModified(VosVacancesI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(VosVacancesI18nPeer::SEO_H1)) {
        ...
        $sql = sprintf(
            'INSERT INTO `vos_vacances_i18n` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aVosVacances !== null) {
                if (!$this->aVosVacances->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aVosVacances->getValidationFailures());
                }
            }


            if (($retval = VosVacancesI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VosVacancesI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VosVacancesI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VosVacancesI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = VosVacancesI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aVosVacances) {
                $result['VosVacances'] = $this->aVosVacances->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VosVacancesI18nPeer::ID)) $criteria->add(VosVacancesI18nPeer::ID, $this->id);
        if ($this->isColumnModified(VosVacancesI18nPeer::LOCALE)) $criteria->add(VosVacancesI18nPeer::LOCALE, $this->locale);
    ...
    {
        $criteria = new Criteria(VosVacancesI18nPeer::DATABASE_NAME);
        $criteria->add(VosVacancesI18nPeer::ID, $this->id);
        $criteria->add(VosVacancesI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of VosVacancesI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VosVacancesI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VosVacancesI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VosVacancesI18nPeer();
        }
    ...
    /**
     * Declares an association between this object and a VosVacances object.
     *
     * @param             VosVacances $v
     * @return VosVacancesI18n The current object (for fluent API support)
     * @throws PropelException
     */
    public function setVosVacances(VosVacances $v = null)
    {
        if ($v === null) {
            $this->setId(NULL);
        } else {
        ...
        // If this object has already been added to the VosVacances object, it will not be re-added.
        if ($v !== null) {
            $v->addVosVacancesI18n($this);
        }
    ...
    /**
     * Get the associated VosVacances object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return VosVacances The associated VosVacances object.
     * @throws PropelException
     */
    public function getVosVacances(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aVosVacances === null && ($this->id !== null) && $doQuery) {
            $this->aVosVacances = VosVacancesQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVosVacances->addVosVacancesI18ns($this);
             */
        }

        return $this->aVosVacances;
    }
    ...
    {
        return (string) $this->exportTo(VosVacancesI18nPeer::DEFAULT_STRING_FORMAT);
    }
