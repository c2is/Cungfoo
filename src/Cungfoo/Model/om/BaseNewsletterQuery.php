 ...
 * @method NewsletterQuery orderByActive($order = Criteria::ASC) Order by the active column
 *
 ...
 * @method NewsletterQuery groupByActive() Group by the active column
 *
 ...
 *
 * @method NewsletterQuery leftJoinNewsletterI18n($relationAlias = null) Adds a LEFT JOIN clause to the query using the NewsletterI18n relation
 * @method NewsletterQuery rightJoinNewsletterI18n($relationAlias = null) Adds a RIGHT JOIN clause to the query using the NewsletterI18n relation
 * @method NewsletterQuery innerJoinNewsletterI18n($relationAlias = null) Adds a INNER JOIN clause to the query using the NewsletterI18n relation
 *
 ...
 * @method Newsletter findOneByActive(boolean $active) Return the first Newsletter filtered by the active column
 *
 ...
 * @method array findByActive(boolean $active) Return Newsletter objects filtered by the active column
 *
...
abstract class BaseNewsletterQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'cungfoo', $modelName = 'Cungfoo\\Model\\Newsletter', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `email`, `created_at`, `updated_at`, `active` FROM `newsletter` WHERE `id` = :p0';
        try {
    ...
    public function filterByActive($active = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(NewsletterPeer::ACTIVE, $active, $comparison);
    }

    /**
     * Filter the query by a related NewsletterI18n object
     *
     * @param   NewsletterI18n|PropelObjectCollection $newsletterI18n  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   NewsletterQuery The current query, for fluid interface
    ...
    {
        if ($newsletterI18n instanceof NewsletterI18n) {
            return $this
                ->addUsingAlias(NewsletterPeer::ID, $newsletterI18n->getId(), $comparison);
        } elseif ($newsletterI18n instanceof PropelObjectCollection) {
            return $this
                ->useNewsletterI18nQuery()
                ->filterByPrimaryKeys($newsletterI18n->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByNewsletterI18n() only accepts arguments of type NewsletterI18n or PropelCollection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Cungfoo\Model\NewsletterI18nQuery A secondary query class using the current class as primary query
     */
    public function useNewsletterI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinNewsletterI18n($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'NewsletterI18n', '\Cungfoo\Model\NewsletterI18nQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'. Defaults to left join.
     *
     * @return    NewsletterI18nQuery A secondary query class using the current class as primary query
     */
