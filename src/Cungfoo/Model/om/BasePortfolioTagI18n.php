...
/**
 * Base class that represents a row from the 'portfolio_tag_i18n' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BasePortfolioTagI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\PortfolioTagI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PortfolioTagI18nPeer
     */
    ...
    /**
     * Initializes internal state of BasePortfolioTagI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PortfolioTagI18nPeer::ID;
        }

        if ($this->aPortfolioTag !== null && $this->aPortfolioTag->getId() !== $v) {
            $this->aPortfolioTag = null;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = PortfolioTagI18nPeer::LOCALE;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = PortfolioTagI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = PortfolioTagI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = PortfolioTagI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = PortfolioTagI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = PortfolioTagI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPortfolioTag !== null && $this->id !== $this->aPortfolioTag->getId()) {
            $this->aPortfolioTag = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PortfolioTagI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PortfolioTagI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PortfolioTagI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPortfolioTag !== null) {
                if ($this->aPortfolioTag->isModified() || $this->aPortfolioTag->isNew()) {
                    $affectedRows += $this->aPortfolioTag->save($con);
                }
                $this->setPortfolioTag($this->aPortfolioTag);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PortfolioTagI18nPeer::ID)) {
        ...
        if ($this->isColumnModified(PortfolioTagI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(PortfolioTagI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(PortfolioTagI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }
        if ($this->isColumnModified(PortfolioTagI18nPeer::ACTIVE_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`active_locale`';
        }

        $sql = sprintf(
            'INSERT INTO `portfolio_tag_i18n` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aPortfolioTag !== null) {
                if (!$this->aPortfolioTag->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aPortfolioTag->getValidationFailures());
                }
            }


            if (($retval = PortfolioTagI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PortfolioTagI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PortfolioTagI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PortfolioTagI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = PortfolioTagI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aPortfolioTag) {
                $result['PortfolioTag'] = $this->aPortfolioTag->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PortfolioTagI18nPeer::SEO_KEYWORDS)) $criteria->add(PortfolioTagI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
        if ($this->isColumnModified(PortfolioTagI18nPeer::ACTIVE_LOCALE)) $criteria->add(PortfolioTagI18nPeer::ACTIVE_LOCALE, $this->active_locale);
    ...
    {
        $criteria = new Criteria(PortfolioTagI18nPeer::DATABASE_NAME);
        $criteria->add(PortfolioTagI18nPeer::ID, $this->id);
        $criteria->add(PortfolioTagI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of PortfolioTagI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PortfolioTagI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PortfolioTagI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PortfolioTagI18nPeer();
        }
    ...
    /**
     * Declares an association between this object and a PortfolioTag object.
     *
     * @param             PortfolioTag $v
     * @return PortfolioTagI18n The current object (for fluent API support)
     * @throws PropelException
     */
    public function setPortfolioTag(PortfolioTag $v = null)
    {
        if ($v === null) {
            $this->setId(NULL);
        } else {
        ...
        $this->aPortfolioTag = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the PortfolioTag object, it will not be re-added.
        if ($v !== null) {
            $v->addPortfolioTagI18n($this);
        }
    ...
    /**
     * Get the associated PortfolioTag object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return PortfolioTag The associated PortfolioTag object.
     * @throws PropelException
     */
    public function getPortfolioTag(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPortfolioTag === null && ($this->id !== null) && $doQuery) {
            $this->aPortfolioTag = PortfolioTagQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPortfolioTag->addPortfolioTagI18ns($this);
             */
        }

        return $this->aPortfolioTag;
    }
    ...
    {
        return (string) $this->exportTo(PortfolioTagI18nPeer::DEFAULT_STRING_FORMAT);
    }
