...
abstract class BaseEquipement extends BaseObject implements Persistent
{
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = EquipementPeer::CODE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EquipementPeer::CODE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EquipementPeer::CODE)) $criteria->add(EquipementPeer::CODE, $this->code);
