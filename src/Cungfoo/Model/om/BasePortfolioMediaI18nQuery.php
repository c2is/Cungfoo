...
/**
 * Base class that represents a query for the 'portfolio_media_i18n' table.
 *
 *
 *
 ...
 * @method PortfolioMediaI18nQuery orderBySeoKeywords($order = Criteria::ASC) Order by the seo_keywords column
 * @method PortfolioMediaI18nQuery orderByActiveLocale($order = Criteria::ASC) Order by the active_locale column
 *
 ...
 * @method PortfolioMediaI18nQuery groupBySeoKeywords() Group by the seo_keywords column
 * @method PortfolioMediaI18nQuery groupByActiveLocale() Group by the active_locale column
 *
 * @method PortfolioMediaI18nQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method PortfolioMediaI18nQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method PortfolioMediaI18nQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method PortfolioMediaI18nQuery leftJoinPortfolioMedia($relationAlias = null) Adds a LEFT JOIN clause to the query using the PortfolioMedia relation
 * @method PortfolioMediaI18nQuery rightJoinPortfolioMedia($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PortfolioMedia relation
 * @method PortfolioMediaI18nQuery innerJoinPortfolioMedia($relationAlias = null) Adds a INNER JOIN clause to the query using the PortfolioMedia relation
 *
 * @method PortfolioMediaI18n findOne(PropelPDO $con = null) Return the first PortfolioMediaI18n matching the query
 * @method PortfolioMediaI18n findOneOrCreate(PropelPDO $con = null) Return the first PortfolioMediaI18n matching the query, or a new PortfolioMediaI18n object populated from the query conditions when no match is found
 *
 ...
 * @method PortfolioMediaI18n findOneBySeoKeywords(string $seo_keywords) Return the first PortfolioMediaI18n filtered by the seo_keywords column
 * @method PortfolioMediaI18n findOneByActiveLocale(boolean $active_locale) Return the first PortfolioMediaI18n filtered by the active_locale column
 *
 ...
 * @method array findBySeoKeywords(string $seo_keywords) Return PortfolioMediaI18n objects filtered by the seo_keywords column
 * @method array findByActiveLocale(boolean $active_locale) Return PortfolioMediaI18n objects filtered by the active_locale column
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BasePortfolioMediaI18nQuery extends ModelCriteria
{
    /**
     * Initializes internal state of BasePortfolioMediaI18nQuery object.
     *
     * @param     string $dbName The dabase name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cungfoo', $modelName = 'Cungfoo\\Model\\PortfolioMediaI18n', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new PortfolioMediaI18nQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     PortfolioMediaI18nQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return PortfolioMediaI18nQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof PortfolioMediaI18nQuery) {
            return $criteria;
        }
        $query = new PortfolioMediaI18nQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return   PortfolioMediaI18n|PortfolioMediaI18n[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = PortfolioMediaI18nPeer::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && !$this->formatter) {
     ...
     *
     * @return   PortfolioMediaI18n A model object, or null if the key is not found
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new PortfolioMediaI18n();
            $obj->hydrate($row);
            PortfolioMediaI18nPeer::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|PortfolioMediaI18n[]|mixed the list of results, formatted by the current formatter
     */
    ...
    {
        $this->addUsingAlias(PortfolioMediaI18nPeer::ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(PortfolioMediaI18nPeer::LOCALE, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(PortfolioMediaI18nPeer::ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(PortfolioMediaI18nPeer::LOCALE, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PortfolioMediaI18nPeer::ID, $id, $comparison);
    }
    ...
    public function filterBySeoTitle($seoTitle = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PortfolioMediaI18nPeer::SEO_TITLE, $seoTitle, $comparison);
    }
    ...
    public function filterBySeoDescription($seoDescription = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PortfolioMediaI18nPeer::SEO_DESCRIPTION, $seoDescription, $comparison);
    }
    ...
    public function filterBySeoH1($seoH1 = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PortfolioMediaI18nPeer::SEO_H1, $seoH1, $comparison);
    }
    ...
    public function filterBySeoKeywords($seoKeywords = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PortfolioMediaI18nPeer::SEO_KEYWORDS, $seoKeywords, $comparison);
    }
    ...
    public function filterByActiveLocale($activeLocale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PortfolioMediaI18nPeer::ACTIVE_LOCALE, $activeLocale, $comparison);
    }
    ...
    public function filterByPortfolioMedia($portfolioMedia, $comparison = null)
    {
        if ($portfolioMedia instanceof PortfolioMedia) {
            return $this
                ->addUsingAlias(PortfolioMediaI18nPeer::ID, $portfolioMedia->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PortfolioMediaI18nPeer::ID, $portfolioMedia->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     * @return PortfolioMediaI18nQuery The current query, for fluid interface
     */
    public function joinPortfolioMedia($relationAlias = null, $joinType = 'LEFT JOIN')
    {
     ...
     */
    public function usePortfolioMediaQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
     ...
     *
     * @param   PortfolioMediaI18n $portfolioMediaI18n Object to remove from the list of results
     *
     * @return PortfolioMediaI18nQuery The current query, for fluid interface
     */
    public function prune($portfolioMediaI18n = null)
    {
        if ($portfolioMediaI18n) {
            $this->addCond('pruneCond0', $this->getAliasedColName(PortfolioMediaI18nPeer::ID), $portfolioMediaI18n->getId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(PortfolioMediaI18nPeer::LOCALE), $portfolioMediaI18n->getLocale(), Criteria::NOT_EQUAL);
