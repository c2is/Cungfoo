...
abstract class BaseSite extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\SitePeer';
    ...
    public function setOrder($v)
    {
        ...
        if ($this->order !== $v) {
            $this->order = $v;
            $this->modifiedColumns[] = SitePeer::ORDER;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = SitePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SitePeer::ORDER)) $criteria->add(SitePeer::ORDER, $this->order);
