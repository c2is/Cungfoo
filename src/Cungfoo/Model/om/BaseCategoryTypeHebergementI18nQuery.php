...
/**
 * Base class that represents a query for the 'category_type_hebergement_i18n' table.
 *
 *
 *
 ...
 * @method CategoryTypeHebergementI18nQuery orderBySeoTitle($order = Criteria::ASC) Order by the seo_title column
 * @method CategoryTypeHebergementI18nQuery orderBySeoDescription($order = Criteria::ASC) Order by the seo_description column
 * @method CategoryTypeHebergementI18nQuery orderBySeoH1($order = Criteria::ASC) Order by the seo_h1 column
 * @method CategoryTypeHebergementI18nQuery orderBySeoKeywords($order = Criteria::ASC) Order by the seo_keywords column
 *
 ...
 * @method CategoryTypeHebergementI18nQuery groupBySeoTitle() Group by the seo_title column
 * @method CategoryTypeHebergementI18nQuery groupBySeoDescription() Group by the seo_description column
 * @method CategoryTypeHebergementI18nQuery groupBySeoH1() Group by the seo_h1 column
 * @method CategoryTypeHebergementI18nQuery groupBySeoKeywords() Group by the seo_keywords column
 *
 ...
 * @method CategoryTypeHebergementI18nQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method CategoryTypeHebergementI18nQuery leftJoinCategoryTypeHebergement($relationAlias = null) Adds a LEFT JOIN clause to the query using the CategoryTypeHebergement relation
 * @method CategoryTypeHebergementI18nQuery rightJoinCategoryTypeHebergement($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CategoryTypeHebergement relation
 * @method CategoryTypeHebergementI18nQuery innerJoinCategoryTypeHebergement($relationAlias = null) Adds a INNER JOIN clause to the query using the CategoryTypeHebergement relation
 *
 * @method CategoryTypeHebergementI18n findOne(PropelPDO $con = null) Return the first CategoryTypeHebergementI18n matching the query
 * @method CategoryTypeHebergementI18n findOneOrCreate(PropelPDO $con = null) Return the first CategoryTypeHebergementI18n matching the query, or a new CategoryTypeHebergementI18n object populated from the query conditions when no match is found
 *
 ...
 * @method CategoryTypeHebergementI18n findOneBySeoTitle(string $seo_title) Return the first CategoryTypeHebergementI18n filtered by the seo_title column
 * @method CategoryTypeHebergementI18n findOneBySeoDescription(string $seo_description) Return the first CategoryTypeHebergementI18n filtered by the seo_description column
 * @method CategoryTypeHebergementI18n findOneBySeoH1(string $seo_h1) Return the first CategoryTypeHebergementI18n filtered by the seo_h1 column
 * @method CategoryTypeHebergementI18n findOneBySeoKeywords(string $seo_keywords) Return the first CategoryTypeHebergementI18n filtered by the seo_keywords column
 *
 ...
 * @method array findBySeoTitle(string $seo_title) Return CategoryTypeHebergementI18n objects filtered by the seo_title column
 * @method array findBySeoDescription(string $seo_description) Return CategoryTypeHebergementI18n objects filtered by the seo_description column
 * @method array findBySeoH1(string $seo_h1) Return CategoryTypeHebergementI18n objects filtered by the seo_h1 column
 * @method array findBySeoKeywords(string $seo_keywords) Return CategoryTypeHebergementI18n objects filtered by the seo_keywords column
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseCategoryTypeHebergementI18nQuery extends ModelCriteria
{
    /**
     * Initializes internal state of BaseCategoryTypeHebergementI18nQuery object.
     *
     * @param     string $dbName The dabase name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cungfoo', $modelName = 'Cungfoo\\Model\\CategoryTypeHebergementI18n', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new CategoryTypeHebergementI18nQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     CategoryTypeHebergementI18nQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return CategoryTypeHebergementI18nQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof CategoryTypeHebergementI18nQuery) {
            return $criteria;
        }
        $query = new CategoryTypeHebergementI18nQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return   CategoryTypeHebergementI18n|CategoryTypeHebergementI18n[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = CategoryTypeHebergementI18nPeer::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && !$this->formatter) {
     ...
     *
     * @return   CategoryTypeHebergementI18n A model object, or null if the key is not found
     * @throws   PropelException
     */
    protected function findPkSimple($key, $con)
    {
        $sql = 'SELECT `id`, `locale`, `name`, `slug`, `accroche`, `description`, `active_locale`, `seo_title`, `seo_description`, `seo_h1`, `seo_keywords` FROM `category_type_hebergement_i18n` WHERE `id` = :p0 AND `locale` = :p1';
        try {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new CategoryTypeHebergementI18n();
            $obj->hydrate($row);
            CategoryTypeHebergementI18nPeer::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|CategoryTypeHebergementI18n[]|mixed the list of results, formatted by the current formatter
     */
    ...
    {
        $this->addUsingAlias(CategoryTypeHebergementI18nPeer::ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(CategoryTypeHebergementI18nPeer::LOCALE, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(CategoryTypeHebergementI18nPeer::ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(CategoryTypeHebergementI18nPeer::LOCALE, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryTypeHebergementI18nPeer::ID, $id, $comparison);
    }
    ...
    public function filterByLocale($locale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryTypeHebergementI18nPeer::LOCALE, $locale, $comparison);
    }
    ...
    public function filterBySeoTitle($seoTitle = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryTypeHebergementI18nPeer::SEO_TITLE, $seoTitle, $comparison);
    }
    ...
    public function filterBySeoDescription($seoDescription = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryTypeHebergementI18nPeer::SEO_DESCRIPTION, $seoDescription, $comparison);
    }
    ...
    public function filterBySeoH1($seoH1 = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryTypeHebergementI18nPeer::SEO_H1, $seoH1, $comparison);
    }
    ...
    public function filterBySeoKeywords($seoKeywords = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryTypeHebergementI18nPeer::SEO_KEYWORDS, $seoKeywords, $comparison);
    }
    ...
    public function filterByCategoryTypeHebergement($categoryTypeHebergement, $comparison = null)
    {
        if ($categoryTypeHebergement instanceof CategoryTypeHebergement) {
            return $this
                ->addUsingAlias(CategoryTypeHebergementI18nPeer::ID, $categoryTypeHebergement->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CategoryTypeHebergementI18nPeer::ID, $categoryTypeHebergement->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     * @return CategoryTypeHebergementI18nQuery The current query, for fluid interface
     */
    public function joinCategoryTypeHebergement($relationAlias = null, $joinType = 'LEFT JOIN')
    {
     ...
     */
    public function useCategoryTypeHebergementQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
     ...
     *
     * @param   CategoryTypeHebergementI18n $categoryTypeHebergementI18n Object to remove from the list of results
     *
     * @return CategoryTypeHebergementI18nQuery The current query, for fluid interface
     */
    public function prune($categoryTypeHebergementI18n = null)
    {
        if ($categoryTypeHebergementI18n) {
            $this->addCond('pruneCond0', $this->getAliasedColName(CategoryTypeHebergementI18nPeer::ID), $categoryTypeHebergementI18n->getId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(CategoryTypeHebergementI18nPeer::LOCALE), $categoryTypeHebergementI18n->getLocale(), Criteria::NOT_EQUAL);
