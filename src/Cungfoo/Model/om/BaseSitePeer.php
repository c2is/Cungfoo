...
use Cungfoo\Model\map\SiteTableMap;
...
abstract class BaseSitePeer
{
    ...
    const OM_CLASS = 'Cungfoo\\Model\\Site';

    /** the related TableMap class for this table */
    const TM_CLASS = 'SiteTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (SitePeer::ID, SitePeer::NAME, SitePeer::ORDER, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (SitePeer::ID => 0, SitePeer::NAME => 1, SitePeer::ORDER => 2, ),
