...
/**
 * Base class that represents a row from the 'theme_i18n' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseThemeI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\ThemeI18nPeer';
    ...
    /**
     * Initializes internal state of BaseThemeI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ThemeI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = ThemeI18nPeer::LOCALE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ThemeI18nPeer::NAME;
        }
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = ThemeI18nPeer::SLUG;
        }
    ...
    public function setIntroduction($v)
    {
        ...
        if ($this->introduction !== $v) {
            $this->introduction = $v;
            $this->modifiedColumns[] = ThemeI18nPeer::INTRODUCTION;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = ThemeI18nPeer::DESCRIPTION;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = ThemeI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = ThemeI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = ThemeI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = ThemeI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = ThemeI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 11; // 11 = ThemeI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ThemeI18n object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aTheme !== null && $this->id !== $this->aTheme->getId()) {
            $this->aTheme = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ThemeI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ThemeI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ThemeI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ThemeI18nPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ThemeI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(ThemeI18nPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ThemeI18nPeer::SLUG)) {
            $modifiedColumns[':p' . $index++]  = '`slug`';
        }
        if ($this->isColumnModified(ThemeI18nPeer::INTRODUCTION)) {
            $modifiedColumns[':p' . $index++]  = '`introduction`';
        }
        if ($this->isColumnModified(ThemeI18nPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(ThemeI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(ThemeI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(ThemeI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(ThemeI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }
        if ($this->isColumnModified(ThemeI18nPeer::ACTIVE_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`active_locale`';
        }

        $sql = sprintf(
            'INSERT INTO `theme_i18n` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ThemeI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ThemeI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ThemeI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ThemeI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = ThemeI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ThemeI18nPeer::ID)) $criteria->add(ThemeI18nPeer::ID, $this->id);
        if ($this->isColumnModified(ThemeI18nPeer::LOCALE)) $criteria->add(ThemeI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(ThemeI18nPeer::NAME)) $criteria->add(ThemeI18nPeer::NAME, $this->name);
        if ($this->isColumnModified(ThemeI18nPeer::SLUG)) $criteria->add(ThemeI18nPeer::SLUG, $this->slug);
        if ($this->isColumnModified(ThemeI18nPeer::INTRODUCTION)) $criteria->add(ThemeI18nPeer::INTRODUCTION, $this->introduction);
        if ($this->isColumnModified(ThemeI18nPeer::DESCRIPTION)) $criteria->add(ThemeI18nPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(ThemeI18nPeer::SEO_TITLE)) $criteria->add(ThemeI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(ThemeI18nPeer::SEO_DESCRIPTION)) $criteria->add(ThemeI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(ThemeI18nPeer::SEO_H1)) $criteria->add(ThemeI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(ThemeI18nPeer::SEO_KEYWORDS)) $criteria->add(ThemeI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
        if ($this->isColumnModified(ThemeI18nPeer::ACTIVE_LOCALE)) $criteria->add(ThemeI18nPeer::ACTIVE_LOCALE, $this->active_locale);
    ...
    {
        $criteria = new Criteria(ThemeI18nPeer::DATABASE_NAME);
        $criteria->add(ThemeI18nPeer::ID, $this->id);
        $criteria->add(ThemeI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of ThemeI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ThemeI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ThemeI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ThemeI18nPeer();
        }
    ...
    {
        if ($this->aTheme === null && ($this->id !== null) && $doQuery) {
            $this->aTheme = ThemeQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTheme->addThemeI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ThemeI18nPeer::DEFAULT_STRING_FORMAT);
    }
