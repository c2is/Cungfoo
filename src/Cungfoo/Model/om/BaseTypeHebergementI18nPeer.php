...
abstract class BaseTypeHebergementI18nPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Locale', 'Name', 'Slug', 'Indice', 'Surface', 'TypeTerrasse', 'Description', 'Composition', 'Presentation', 'CapaciteHebergement', 'Dimensions', 'Agencement', 'Equipements', 'AnneeUtilisation', 'Remarque1', 'Remarque2', 'Remarque3', 'Remarque4', 'ActiveLocale', 'SeoTitle', 'SeoDescription', 'SeoH1', 'SeoKeywords', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'locale', 'name', 'slug', 'indice', 'surface', 'typeTerrasse', 'description', 'composition', 'presentation', 'capaciteHebergement', 'dimensions', 'agencement', 'equipements', 'anneeUtilisation', 'remarque1', 'remarque2', 'remarque3', 'remarque4', 'activeLocale', 'seoTitle', 'seoDescription', 'seoH1', 'seoKeywords', ),
        BasePeer::TYPE_COLNAME => array (TypeHebergementI18nPeer::ID, TypeHebergementI18nPeer::LOCALE, TypeHebergementI18nPeer::NAME, TypeHebergementI18nPeer::SLUG, TypeHebergementI18nPeer::INDICE, TypeHebergementI18nPeer::SURFACE, TypeHebergementI18nPeer::TYPE_TERRASSE, TypeHebergementI18nPeer::DESCRIPTION, TypeHebergementI18nPeer::COMPOSITION, TypeHebergementI18nPeer::PRESENTATION, TypeHebergementI18nPeer::CAPACITE_HEBERGEMENT, TypeHebergementI18nPeer::DIMENSIONS, TypeHebergementI18nPeer::AGENCEMENT, TypeHebergementI18nPeer::EQUIPEMENTS, TypeHebergementI18nPeer::ANNEE_UTILISATION, TypeHebergementI18nPeer::REMARQUE_1, TypeHebergementI18nPeer::REMARQUE_2, TypeHebergementI18nPeer::REMARQUE_3, TypeHebergementI18nPeer::REMARQUE_4, TypeHebergementI18nPeer::ACTIVE_LOCALE, TypeHebergementI18nPeer::SEO_TITLE, TypeHebergementI18nPeer::SEO_DESCRIPTION, TypeHebergementI18nPeer::SEO_H1, TypeHebergementI18nPeer::SEO_KEYWORDS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'LOCALE', 'NAME', 'SLUG', 'INDICE', 'SURFACE', 'TYPE_TERRASSE', 'DESCRIPTION', 'COMPOSITION', 'PRESENTATION', 'CAPACITE_HEBERGEMENT', 'DIMENSIONS', 'AGENCEMENT', 'EQUIPEMENTS', 'ANNEE_UTILISATION', 'REMARQUE_1', 'REMARQUE_2', 'REMARQUE_3', 'REMARQUE_4', 'ACTIVE_LOCALE', 'SEO_TITLE', 'SEO_DESCRIPTION', 'SEO_H1', 'SEO_KEYWORDS', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'locale', 'name', 'slug', 'indice', 'surface', 'type_terrasse', 'description', 'composition', 'presentation', 'capacite_hebergement', 'dimensions', 'agencement', 'equipements', 'annee_utilisation', 'remarque_1', 'remarque_2', 'remarque_3', 'remarque_4', 'active_locale', 'seo_title', 'seo_description', 'seo_h1', 'seo_keywords', ),
