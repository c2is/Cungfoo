...
abstract class BaseThematiqueI18nQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `locale`, `name`, `description`, `keywords`, `active_locale`, `seo_title`, `seo_description`, `seo_h1`, `seo_keywords` FROM `thematique_i18n` WHERE `id` = :p0 AND `locale` = :p1';
        try {
