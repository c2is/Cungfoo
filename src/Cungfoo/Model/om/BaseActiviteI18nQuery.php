...
/**
 * Base class that represents a query for the 'activite_i18n' table.
 *
 *
 *
 ...
 * @method ActiviteI18nQuery orderByActiveLocale($order = Criteria::ASC) Order by the active_locale column
 * @method ActiviteI18nQuery orderBySeoTitle($order = Criteria::ASC) Order by the seo_title column
 * @method ActiviteI18nQuery orderBySeoDescription($order = Criteria::ASC) Order by the seo_description column
 * @method ActiviteI18nQuery orderBySeoH1($order = Criteria::ASC) Order by the seo_h1 column
 * @method ActiviteI18nQuery orderBySeoKeywords($order = Criteria::ASC) Order by the seo_keywords column
 *
 ...
 * @method ActiviteI18nQuery groupByActiveLocale() Group by the active_locale column
 * @method ActiviteI18nQuery groupBySeoTitle() Group by the seo_title column
 * @method ActiviteI18nQuery groupBySeoDescription() Group by the seo_description column
 * @method ActiviteI18nQuery groupBySeoH1() Group by the seo_h1 column
 * @method ActiviteI18nQuery groupBySeoKeywords() Group by the seo_keywords column
 *
 ...
 * @method ActiviteI18nQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method ActiviteI18nQuery leftJoinActivite($relationAlias = null) Adds a LEFT JOIN clause to the query using the Activite relation
 * @method ActiviteI18nQuery rightJoinActivite($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Activite relation
 * @method ActiviteI18nQuery innerJoinActivite($relationAlias = null) Adds a INNER JOIN clause to the query using the Activite relation
 *
 ...
 * @method ActiviteI18n findOneByActiveLocale(boolean $active_locale) Return the first ActiviteI18n filtered by the active_locale column
 * @method ActiviteI18n findOneBySeoTitle(string $seo_title) Return the first ActiviteI18n filtered by the seo_title column
 * @method ActiviteI18n findOneBySeoDescription(string $seo_description) Return the first ActiviteI18n filtered by the seo_description column
 * @method ActiviteI18n findOneBySeoH1(string $seo_h1) Return the first ActiviteI18n filtered by the seo_h1 column
 * @method ActiviteI18n findOneBySeoKeywords(string $seo_keywords) Return the first ActiviteI18n filtered by the seo_keywords column
 *
 ...
 * @method array findByActiveLocale(boolean $active_locale) Return ActiviteI18n objects filtered by the active_locale column
 * @method array findBySeoTitle(string $seo_title) Return ActiviteI18n objects filtered by the seo_title column
 * @method array findBySeoDescription(string $seo_description) Return ActiviteI18n objects filtered by the seo_description column
 * @method array findBySeoH1(string $seo_h1) Return ActiviteI18n objects filtered by the seo_h1 column
 * @method array findBySeoKeywords(string $seo_keywords) Return ActiviteI18n objects filtered by the seo_keywords column
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseActiviteI18nQuery extends ModelCriteria
{
    /**
     * Initializes internal state of BaseActiviteI18nQuery object.
     *
     * @param     string $dbName The dabase name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'cungfoo', $modelName = 'Cungfoo\\Model\\ActiviteI18n', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ActiviteI18nQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     ActiviteI18nQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return ActiviteI18nQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof ActiviteI18nQuery) {
            return $criteria;
        }
        $query = new ActiviteI18nQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return   ActiviteI18n|ActiviteI18n[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = ActiviteI18nPeer::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && !$this->formatter) {
     ...
     *
     * @return   ActiviteI18n A model object, or null if the key is not found
     * @throws   PropelException
     */
    protected function findPkSimple($key, $con)
    {
        $sql = 'SELECT `id`, `locale`, `name`, `description`, `keywords`, `active_locale`, `seo_title`, `seo_description`, `seo_h1`, `seo_keywords` FROM `activite_i18n` WHERE `id` = :p0 AND `locale` = :p1';
        try {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new ActiviteI18n();
            $obj->hydrate($row);
            ActiviteI18nPeer::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|ActiviteI18n[]|mixed the list of results, formatted by the current formatter
     */
    ...
    {
        $this->addUsingAlias(ActiviteI18nPeer::ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(ActiviteI18nPeer::LOCALE, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(ActiviteI18nPeer::ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(ActiviteI18nPeer::LOCALE, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterByLocale($locale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ActiviteI18nPeer::LOCALE, $locale, $comparison);
    }
    ...
    public function filterByActiveLocale($activeLocale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ActiviteI18nPeer::ACTIVE_LOCALE, $activeLocale, $comparison);
    }
    ...
    public function filterBySeoTitle($seoTitle = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ActiviteI18nPeer::SEO_TITLE, $seoTitle, $comparison);
    }
    ...
    public function filterBySeoDescription($seoDescription = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ActiviteI18nPeer::SEO_DESCRIPTION, $seoDescription, $comparison);
    }
    ...
    public function filterBySeoH1($seoH1 = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ActiviteI18nPeer::SEO_H1, $seoH1, $comparison);
    }
    ...
    public function filterBySeoKeywords($seoKeywords = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ActiviteI18nPeer::SEO_KEYWORDS, $seoKeywords, $comparison);
    }
    ...
    public function filterByActivite($activite, $comparison = null)
    {
        if ($activite instanceof Activite) {
            return $this
                ->addUsingAlias(ActiviteI18nPeer::ID, $activite->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ActiviteI18nPeer::ID, $activite->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     * @return ActiviteI18nQuery The current query, for fluid interface
     */
    public function joinActivite($relationAlias = null, $joinType = 'LEFT JOIN')
    {
     ...
     */
    public function useActiviteQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
     ...
     *
     * @param   ActiviteI18n $activiteI18n Object to remove from the list of results
     *
     * @return ActiviteI18nQuery The current query, for fluid interface
     */
    public function prune($activiteI18n = null)
    {
        if ($activiteI18n) {
            $this->addCond('pruneCond0', $this->getAliasedColName(ActiviteI18nPeer::ID), $activiteI18n->getId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(ActiviteI18nPeer::LOCALE), $activiteI18n->getLocale(), Criteria::NOT_EQUAL);
