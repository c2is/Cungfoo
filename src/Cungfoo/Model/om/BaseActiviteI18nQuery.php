...
abstract class BaseActiviteI18nQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `locale`, `name`, `description`, `keywords`, `seo_title`, `seo_description`, `seo_h1`, `seo_keywords`, `active_locale` FROM `activite_i18n` WHERE `id` = :p0 AND `locale` = :p1';
        try {
