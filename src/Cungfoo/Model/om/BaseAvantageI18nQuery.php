 ...
 * @method AvantageI18nQuery orderBySeoTitle($order = Criteria::ASC) Order by the seo_title column
 * @method AvantageI18nQuery orderBySeoDescription($order = Criteria::ASC) Order by the seo_description column
 * @method AvantageI18nQuery orderBySeoH1($order = Criteria::ASC) Order by the seo_h1 column
 * @method AvantageI18nQuery orderBySeoKeywords($order = Criteria::ASC) Order by the seo_keywords column
 * @method AvantageI18nQuery orderByActiveLocale($order = Criteria::ASC) Order by the active_locale column
 *
 ...
 * @method AvantageI18nQuery groupBySeoTitle() Group by the seo_title column
 * @method AvantageI18nQuery groupBySeoDescription() Group by the seo_description column
 * @method AvantageI18nQuery groupBySeoH1() Group by the seo_h1 column
 * @method AvantageI18nQuery groupBySeoKeywords() Group by the seo_keywords column
 * @method AvantageI18nQuery groupByActiveLocale() Group by the active_locale column
 *
 ...
 * @method AvantageI18n findOneBySeoTitle(string $seo_title) Return the first AvantageI18n filtered by the seo_title column
 * @method AvantageI18n findOneBySeoDescription(string $seo_description) Return the first AvantageI18n filtered by the seo_description column
 * @method AvantageI18n findOneBySeoH1(string $seo_h1) Return the first AvantageI18n filtered by the seo_h1 column
 * @method AvantageI18n findOneBySeoKeywords(string $seo_keywords) Return the first AvantageI18n filtered by the seo_keywords column
 * @method AvantageI18n findOneByActiveLocale(boolean $active_locale) Return the first AvantageI18n filtered by the active_locale column
 *
 ...
 * @method array findBySeoTitle(string $seo_title) Return AvantageI18n objects filtered by the seo_title column
 * @method array findBySeoDescription(string $seo_description) Return AvantageI18n objects filtered by the seo_description column
 * @method array findBySeoH1(string $seo_h1) Return AvantageI18n objects filtered by the seo_h1 column
 * @method array findBySeoKeywords(string $seo_keywords) Return AvantageI18n objects filtered by the seo_keywords column
 * @method array findByActiveLocale(boolean $active_locale) Return AvantageI18n objects filtered by the active_locale column
 *
...
abstract class BaseAvantageI18nQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `locale`, `name`, `description`, `seo_title`, `seo_description`, `seo_h1`, `seo_keywords`, `active_locale` FROM `avantage_i18n` WHERE `id` = :p0 AND `locale` = :p1';
        try {
    ...
    public function filterBySeoTitle($seoTitle = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AvantageI18nPeer::SEO_TITLE, $seoTitle, $comparison);
    }
    ...
    public function filterBySeoDescription($seoDescription = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AvantageI18nPeer::SEO_DESCRIPTION, $seoDescription, $comparison);
    }
    ...
    public function filterBySeoH1($seoH1 = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AvantageI18nPeer::SEO_H1, $seoH1, $comparison);
    }
    ...
    public function filterBySeoKeywords($seoKeywords = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AvantageI18nPeer::SEO_KEYWORDS, $seoKeywords, $comparison);
    }
    ...
    public function filterByActiveLocale($activeLocale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AvantageI18nPeer::ACTIVE_LOCALE, $activeLocale, $comparison);
    }
