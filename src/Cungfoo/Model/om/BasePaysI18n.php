 ...
 */
abstract class BasePaysI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\PaysI18nPeer';
    ...
    /**
     * Initializes internal state of BasePaysI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PaysI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = PaysI18nPeer::LOCALE;
        }
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = PaysI18nPeer::SLUG;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = PaysI18nPeer::NAME;
        }
    ...
    public function setIntroduction($v)
    {
        ...
        if ($this->introduction !== $v) {
            $this->introduction = $v;
            $this->modifiedColumns[] = PaysI18nPeer::INTRODUCTION;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PaysI18nPeer::DESCRIPTION;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = PaysI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = PaysI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = PaysI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = PaysI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = PaysI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 11; // 11 = PaysI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PaysI18n object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPays !== null && $this->id !== $this->aPays->getId()) {
            $this->aPays = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PaysI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PaysI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PaysI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PaysI18nPeer::SLUG)) {
        ...
        if ($this->isColumnModified(PaysI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(PaysI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(PaysI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(PaysI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }
        if ($this->isColumnModified(PaysI18nPeer::ACTIVE_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`active_locale`';
        }

        $sql = sprintf(
            'INSERT INTO `pays_i18n` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PaysI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PaysI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PaysI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PaysI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = PaysI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PaysI18nPeer::ID)) $criteria->add(PaysI18nPeer::ID, $this->id);
        if ($this->isColumnModified(PaysI18nPeer::LOCALE)) $criteria->add(PaysI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(PaysI18nPeer::SLUG)) $criteria->add(PaysI18nPeer::SLUG, $this->slug);
        if ($this->isColumnModified(PaysI18nPeer::NAME)) $criteria->add(PaysI18nPeer::NAME, $this->name);
        if ($this->isColumnModified(PaysI18nPeer::INTRODUCTION)) $criteria->add(PaysI18nPeer::INTRODUCTION, $this->introduction);
        if ($this->isColumnModified(PaysI18nPeer::DESCRIPTION)) $criteria->add(PaysI18nPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PaysI18nPeer::SEO_TITLE)) $criteria->add(PaysI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(PaysI18nPeer::SEO_DESCRIPTION)) $criteria->add(PaysI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(PaysI18nPeer::SEO_H1)) $criteria->add(PaysI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(PaysI18nPeer::SEO_KEYWORDS)) $criteria->add(PaysI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
        if ($this->isColumnModified(PaysI18nPeer::ACTIVE_LOCALE)) $criteria->add(PaysI18nPeer::ACTIVE_LOCALE, $this->active_locale);
    ...
    {
        $criteria = new Criteria(PaysI18nPeer::DATABASE_NAME);
        $criteria->add(PaysI18nPeer::ID, $this->id);
        $criteria->add(PaysI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of PaysI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PaysI18n Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PaysI18nPeer::DEFAULT_STRING_FORMAT);
    }
