...
/**
 * Base class that represents a row from the 'bon_plan_i18n' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseBonPlanI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\BonPlanI18nPeer';
    ...
    /**
     * Initializes internal state of BaseBonPlanI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BonPlanI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = BonPlanI18nPeer::LOCALE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = BonPlanI18nPeer::NAME;
        }
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = BonPlanI18nPeer::SLUG;
        }
    ...
    public function setIntroduction($v)
    {
        ...
        if ($this->introduction !== $v) {
            $this->introduction = $v;
            $this->modifiedColumns[] = BonPlanI18nPeer::INTRODUCTION;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = BonPlanI18nPeer::DESCRIPTION;
        }
    ...
    public function setIndice($v)
    {
        ...
        if ($this->indice !== $v) {
            $this->indice = $v;
            $this->modifiedColumns[] = BonPlanI18nPeer::INDICE;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = BonPlanI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = BonPlanI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = BonPlanI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = BonPlanI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->seo_title = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->seo_description = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->seo_h1 = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->seo_keywords = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->resetModified();
            ...
            return $startcol + 13; // 13 = BonPlanI18nPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aBonPlan !== null && $this->id !== $this->aBonPlan->getId()) {
            $this->aBonPlan = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BonPlanI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BonPlanI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BonPlanI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BonPlanI18nPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(BonPlanI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(BonPlanI18nPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(BonPlanI18nPeer::SLUG)) {
            $modifiedColumns[':p' . $index++]  = '`slug`';
        }
        if ($this->isColumnModified(BonPlanI18nPeer::INTRODUCTION)) {
            $modifiedColumns[':p' . $index++]  = '`introduction`';
        }
        if ($this->isColumnModified(BonPlanI18nPeer::DESCRIPTION)) {
        ...
        if ($this->isColumnModified(BonPlanI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(BonPlanI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(BonPlanI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(BonPlanI18nPeer::SEO_KEYWORDS)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BonPlanI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BonPlanI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BonPlanI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BonPlanI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = BonPlanI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[9] => $this->getSeoTitle(),
            $keys[10] => $this->getSeoDescription(),
            $keys[11] => $this->getSeoH1(),
            $keys[12] => $this->getSeoKeywords(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[9], $arr)) $this->setSeoTitle($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setSeoDescription($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setSeoH1($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setSeoKeywords($arr[$keys[12]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BonPlanI18nPeer::ID)) $criteria->add(BonPlanI18nPeer::ID, $this->id);
        if ($this->isColumnModified(BonPlanI18nPeer::LOCALE)) $criteria->add(BonPlanI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(BonPlanI18nPeer::NAME)) $criteria->add(BonPlanI18nPeer::NAME, $this->name);
        if ($this->isColumnModified(BonPlanI18nPeer::SLUG)) $criteria->add(BonPlanI18nPeer::SLUG, $this->slug);
        ...
        if ($this->isColumnModified(BonPlanI18nPeer::SEO_TITLE)) $criteria->add(BonPlanI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(BonPlanI18nPeer::SEO_DESCRIPTION)) $criteria->add(BonPlanI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(BonPlanI18nPeer::SEO_H1)) $criteria->add(BonPlanI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(BonPlanI18nPeer::SEO_KEYWORDS)) $criteria->add(BonPlanI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
    ...
    {
        $criteria = new Criteria(BonPlanI18nPeer::DATABASE_NAME);
        $criteria->add(BonPlanI18nPeer::ID, $this->id);
        $criteria->add(BonPlanI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of BonPlanI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BonPlanI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BonPlanI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BonPlanI18nPeer();
        }
    ...
    {
        if ($this->aBonPlan === null && ($this->id !== null) && $doQuery) {
            $this->aBonPlan = BonPlanQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBonPlan->addBonPlanI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BonPlanI18nPeer::DEFAULT_STRING_FORMAT);
    }
