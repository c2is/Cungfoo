...
/**
 * Base class that represents a row from the 'region_point_interet' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseRegionPointInteret extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\RegionPointInteretPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RegionPointInteretPeer
     */
     ...
     * @return RegionPointInteret The current object (for fluent API support)
     */
    public function setRegionId($v)
    {
        ...
        if ($this->region_id !== $v) {
            $this->region_id = $v;
            $this->modifiedColumns[] = RegionPointInteretPeer::REGION_ID;
        }
    ...
    public function setPointInteretId($v)
    {
        ...
        if ($this->point_interet_id !== $v) {
            ...
            $this->modifiedColumns[] = RegionPointInteretPeer::POINT_INTERET_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = RegionPointInteretPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RegionPointInteret object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RegionPointInteretPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RegionPointInteretQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RegionPointInteretPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RegionPointInteretPeer::REGION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`region_id`';
        }
        if ($this->isColumnModified(RegionPointInteretPeer::POINT_INTERET_ID)) {
            $modifiedColumns[':p' . $index++]  = '`point_interet_id`';
        }

        $sql = sprintf(
            'INSERT INTO `region_point_interet` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RegionPointInteretPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RegionPointInteretPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['RegionPointInteret'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RegionPointInteret'][serialize($this->getPrimaryKey())] = true;
        $keys = RegionPointInteretPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RegionPointInteretPeer::REGION_ID)) $criteria->add(RegionPointInteretPeer::REGION_ID, $this->region_id);
        if ($this->isColumnModified(RegionPointInteretPeer::POINT_INTERET_ID)) $criteria->add(RegionPointInteretPeer::POINT_INTERET_ID, $this->point_interet_id);
    ...
    {
        $criteria = new Criteria(RegionPointInteretPeer::DATABASE_NAME);
        $criteria->add(RegionPointInteretPeer::REGION_ID, $this->region_id);
        $criteria->add(RegionPointInteretPeer::POINT_INTERET_ID, $this->point_interet_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getRegionId()) && (null === $this->getPointInteretId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of RegionPointInteret (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RegionPointInteret Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RegionPointInteretPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RegionPointInteretPeer();
        }
    ...
    public function getRegion(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRegion === null && ($this->region_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aRegion->addRegionPointInterets($this);
             */
        }
    ...
    public function getPointInteret(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPointInteret === null && ($this->point_interet_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPointInteret->addRegionPointInterets($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(RegionPointInteretPeer::DEFAULT_STRING_FORMAT);
    }
