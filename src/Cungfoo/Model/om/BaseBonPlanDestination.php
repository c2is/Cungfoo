...
/**
 * Base class that represents a row from the 'bon_plan_destination' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseBonPlanDestination extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\BonPlanDestinationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BonPlanDestinationPeer
     */
     ...
     * @return BonPlanDestination The current object (for fluent API support)
     */
    public function setBonPlanId($v)
    {
        ...
        if ($this->bon_plan_id !== $v) {
            $this->bon_plan_id = $v;
            $this->modifiedColumns[] = BonPlanDestinationPeer::BON_PLAN_ID;
        }
    ...
    public function setDestinationId($v)
    {
        ...
        if ($this->destination_id !== $v) {
            ...
            $this->modifiedColumns[] = BonPlanDestinationPeer::DESTINATION_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = BonPlanDestinationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BonPlanDestination object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BonPlanDestinationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BonPlanDestinationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BonPlanDestinationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BonPlanDestinationPeer::BON_PLAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bon_plan_id`';
        }
        if ($this->isColumnModified(BonPlanDestinationPeer::DESTINATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`destination_id`';
        }

        $sql = sprintf(
            'INSERT INTO `bon_plan_destination` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BonPlanDestinationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BonPlanDestinationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BonPlanDestination'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BonPlanDestination'][serialize($this->getPrimaryKey())] = true;
        $keys = BonPlanDestinationPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BonPlanDestinationPeer::BON_PLAN_ID)) $criteria->add(BonPlanDestinationPeer::BON_PLAN_ID, $this->bon_plan_id);
        if ($this->isColumnModified(BonPlanDestinationPeer::DESTINATION_ID)) $criteria->add(BonPlanDestinationPeer::DESTINATION_ID, $this->destination_id);
    ...
    {
        $criteria = new Criteria(BonPlanDestinationPeer::DATABASE_NAME);
        $criteria->add(BonPlanDestinationPeer::BON_PLAN_ID, $this->bon_plan_id);
        $criteria->add(BonPlanDestinationPeer::DESTINATION_ID, $this->destination_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getBonPlanId()) && (null === $this->getDestinationId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of BonPlanDestination (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BonPlanDestination Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BonPlanDestinationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BonPlanDestinationPeer();
        }
    ...
    public function getBonPlan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBonPlan === null && ($this->bon_plan_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBonPlan->addBonPlanDestinations($this);
             */
        }
    ...
    public function getDestination(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDestination === null && ($this->destination_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDestination->addBonPlanDestinations($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BonPlanDestinationPeer::DEFAULT_STRING_FORMAT);
    }
