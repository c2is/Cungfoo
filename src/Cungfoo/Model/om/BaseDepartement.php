 ...
 */
abstract class BaseDepartement extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\DepartementPeer';
    ...
    /**
     * The value for the region_ref_id field.
     * @var        int
     */
    ...
    /**
     * @var        PropelObjectCollection|DepartementI18n[] Collection to store aggregation of DepartementI18n objects.
     */
    protected $collDepartementI18ns;
    protected $collDepartementI18nsPartial;
     ...
     * @var		PropelObjectCollection
     */
    protected $departementI18nsScheduledForDeletion = null;
    ...
    /**
     * Initializes internal state of BaseDepartement object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [region_ref_id] column value.
     *
     * @return int
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DepartementPeer::ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = DepartementPeer::CODE;
        }
    ...
    /**
     * Set the value of [region_ref_id] column.
     *
     * @param int $v new value
     * @return Departement The current object (for fluent API support)
     */
    public function setRegionRefId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->region_ref_id !== $v) {
            $this->region_ref_id = $v;
            $this->modifiedColumns[] = DepartementPeer::REGION_REF_ID;
        }

        if ($this->aRegionRef !== null && $this->aRegionRef->getId() !== $v) {
            $this->aRegionRef = null;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DepartementPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DepartementPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = DepartementPeer::ACTIVE;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aRegionRef !== null && $this->region_ref_id !== $this->aRegionRef->getId()) {
            $this->aRegionRef = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DepartementPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
        ...
        if ($deep) {  // also de-associate any related objects?
            ...
            $this->collDepartementI18ns = null;
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DepartementQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(DepartementPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(DepartementPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                DepartementPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aRegionRef !== null) {
                if ($this->aRegionRef->isModified() || $this->aRegionRef->isNew()) {
                    $affectedRows += $this->aRegionRef->save($con);
                }
                $this->setRegionRef($this->aRegionRef);
            }
            ...
            if ($this->departementI18nsScheduledForDeletion !== null) {
                if (!$this->departementI18nsScheduledForDeletion->isEmpty()) {
                    DepartementI18nQuery::create()
                        ->filterByPrimaryKeys($this->departementI18nsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->departementI18nsScheduledForDeletion = null;
                }
            }

            if ($this->collDepartementI18ns !== null) {
                foreach ($this->collDepartementI18ns as $referrerFK) {
                    if (!$referrerFK->isDeleted() && ($referrerFK->isNew() || $referrerFK->isModified())) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DepartementPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(DepartementPeer::CODE)) {
        ...
        if ($this->isColumnModified(DepartementPeer::ACTIVE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aRegionRef !== null) {
                if (!$this->aRegionRef->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aRegionRef->getValidationFailures());
                }
            }


            if (($retval = DepartementPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DepartementPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Departement'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Departement'][$this->getPrimaryKey()] = true;
        $keys = DepartementPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aRegionRef) {
                $result['RegionRef'] = $this->aRegionRef->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            ...
            if (null !== $this->collDepartementI18ns) {
                $result['DepartementI18ns'] = $this->collDepartementI18ns->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    {
        $criteria = new Criteria(DepartementPeer::DATABASE_NAME);
        $criteria->add(DepartementPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Departement (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getDepartementI18ns() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addDepartementI18n($relObj->copy($deepCopy));
                }
            }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Departement Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DepartementPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DepartementPeer();
        }
    ...
    /**
     * Declares an association between this object and a RegionRef object.
     *
     * @param             RegionRef $v
     * @return Departement The current object (for fluent API support)
     * @throws PropelException
     */
    public function setRegionRef(RegionRef $v = null)
    {
        if ($v === null) {
            $this->setRegionRefId(NULL);
        } else {
            $this->setRegionRefId($v->getId());
        }

        $this->aRegionRef = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the RegionRef object, it will not be re-added.
        if ($v !== null) {
    ...
    /**
     * Get the associated RegionRef object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return RegionRef The associated RegionRef object.
     * @throws PropelException
     */
    public function getRegionRef(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRegionRef === null && ($this->region_ref_id !== null) && $doQuery) {
            $this->aRegionRef = RegionRefQuery::create()->findPk($this->region_ref_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRegionRef->addDepartements($this);
             */
        }

        return $this->aRegionRef;
    }
    ...
    public function initRelation($relationName)
    {
        ...
        if ('DepartementI18n' == $relationName) {
            $this->initDepartementI18ns();
        }
    }
     ...
     * If this Departement is new, it will return
    ...
    public function setEtablissements(PropelCollection $etablissements, PropelPDO $con = null)
    {
        ...
        foreach ($this->etablissementsScheduledForDeletion as $etablissementRemoved) {
            $etablissementRemoved->setDepartement(null);
        }
     ...
     * Otherwise if this Departement is new, it will return
     * an empty collection; or if this Departement has previously
     * been saved, it will retrieve related Etablissements from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Departement.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    /**
     * Clears out the collDepartementI18ns collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return Departement The current object (for fluent API support)
     * @see        addDepartementI18ns()
     */
    public function clearDepartementI18ns()
    {
        $this->collDepartementI18ns = null; // important to set this to null since that means it is uninitialized
        $this->collDepartementI18nsPartial = null;

        return $this;
    }

    /**
     * reset is the collDepartementI18ns collection loaded partially
     *
     * @return void
     */
    public function resetPartialDepartementI18ns($v = true)
    {
        $this->collDepartementI18nsPartial = $v;
    }

    /**
     * Initializes the collDepartementI18ns collection.
     *
     * By default this just sets the collDepartementI18ns collection to an empty array (like clearcollDepartementI18ns());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initDepartementI18ns($overrideExisting = true)
    {
        if (null !== $this->collDepartementI18ns && !$overrideExisting) {
            return;
        }
        $this->collDepartementI18ns = new PropelObjectCollection();
        $this->collDepartementI18ns->setModel('DepartementI18n');
    }

    /**
     * Gets an array of DepartementI18n objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|DepartementI18n[] List of DepartementI18n objects
     * @throws PropelException
     */
    public function getDepartementI18ns($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collDepartementI18nsPartial && !$this->isNew();
        if (null === $this->collDepartementI18ns || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collDepartementI18ns) {
                // return empty collection
                $this->initDepartementI18ns();
            } else {
                $collDepartementI18ns = DepartementI18nQuery::create(null, $criteria)
                    ->filterByDepartement($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collDepartementI18nsPartial && count($collDepartementI18ns)) {
                      $this->initDepartementI18ns(false);

                      foreach($collDepartementI18ns as $obj) {
                        if (false == $this->collDepartementI18ns->contains($obj)) {
                          $this->collDepartementI18ns->append($obj);
                        }
                      }

                      $this->collDepartementI18nsPartial = true;
                    }

                    return $collDepartementI18ns;
                }

                if($partial && $this->collDepartementI18ns) {
                    foreach($this->collDepartementI18ns as $obj) {
                        if($obj->isNew()) {
                            $collDepartementI18ns[] = $obj;
                        }
                    }
                }

                $this->collDepartementI18ns = $collDepartementI18ns;
                $this->collDepartementI18nsPartial = false;
            }
        }

        return $this->collDepartementI18ns;
    }

    /**
     * Sets a collection of DepartementI18n objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $departementI18ns A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return Departement The current object (for fluent API support)
     */
    public function setDepartementI18ns(PropelCollection $departementI18ns, PropelPDO $con = null)
    {
        $this->departementI18nsScheduledForDeletion = $this->getDepartementI18ns(new Criteria(), $con)->diff($departementI18ns);

        foreach ($this->departementI18nsScheduledForDeletion as $departementI18nRemoved) {
            $departementI18nRemoved->setDepartement(null);
        }

        $this->collDepartementI18ns = null;
        foreach ($departementI18ns as $departementI18n) {
            $this->addDepartementI18n($departementI18n);
        }

        $this->collDepartementI18ns = $departementI18ns;
        $this->collDepartementI18nsPartial = false;
    ...
    /**
     * Returns the number of related DepartementI18n objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related DepartementI18n objects.
     * @throws PropelException
     */
    public function countDepartementI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collDepartementI18nsPartial && !$this->isNew();
        if (null === $this->collDepartementI18ns || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collDepartementI18ns) {
            ...
            if($partial && !$criteria) {
                return count($this->getDepartementI18ns());
            }
            $query = DepartementI18nQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collDepartementI18ns);
    }

    /**
     * Method called to associate a DepartementI18n object to this object
     * through the DepartementI18n foreign key attribute.
     *
     * @param    DepartementI18n $l DepartementI18n
     * @return Departement The current object (for fluent API support)
     */
    public function addDepartementI18n(DepartementI18n $l)
    {
        ...
        if (!in_array($l, $this->collDepartementI18ns->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddDepartementI18n($l);
        }
    ...
    /**
     * @param	DepartementI18n $departementI18n The departementI18n object to add.
     */
    protected function doAddDepartementI18n($departementI18n)
    {
        $this->collDepartementI18ns[]= $departementI18n;
        $departementI18n->setDepartement($this);
    }

    /**
     * @param	DepartementI18n $departementI18n The departementI18n object to remove.
     * @return Departement The current object (for fluent API support)
     */
    public function removeDepartementI18n($departementI18n)
    {
        if ($this->getDepartementI18ns()->contains($departementI18n)) {
            $this->collDepartementI18ns->remove($this->collDepartementI18ns->search($departementI18n));
            if (null === $this->departementI18nsScheduledForDeletion) {
                $this->departementI18nsScheduledForDeletion = clone $this->collDepartementI18ns;
                $this->departementI18nsScheduledForDeletion->clear();
            }
            $this->departementI18nsScheduledForDeletion[]= $departementI18n;
            $departementI18n->setDepartement(null);
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep) {
            ...
            if ($this->collDepartementI18ns) {
                foreach ($this->collDepartementI18ns as $o) {
                    $o->clearAllReferences($deep);
                }
            }
        } // if ($deep)
        ...
        $this->collEtablissements = null;
        if ($this->collDepartementI18ns instanceof PropelCollection) {
            $this->collDepartementI18ns->clearIterator();
        }
        $this->collDepartementI18ns = null;
        $this->aRegionRef = null;
    }
    ...
    {
        return (string) $this->exportTo(DepartementPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function getTranslation($locale = 'fr', PropelPDO $con = null)
    {
        if (!isset($this->currentTranslations[$locale])) {
            if (null !== $this->collDepartementI18ns) {
                foreach ($this->collDepartementI18ns as $translation) {
            ...
            if ($this->isNew()) {
                $translation = new DepartementI18n();
                $translation->setLocale($locale);
            } else {
                $translation = DepartementI18nQuery::create()
                    ->filterByPrimaryKey(array($this->getPrimaryKey(), $locale))
                    ->findOneOrCreate($con);
                $this->currentTranslations[$locale] = $translation;
            }
            $this->addDepartementI18n($translation);
        }
    ...
    public function removeTranslation($locale = 'fr', PropelPDO $con = null)
    {
        ...
        foreach ($this->collDepartementI18ns as $key => $translation) {
            if ($translation->getLocale() == $locale) {
                unset($this->collDepartementI18ns[$key]);
                break;
            }
        }
    ...
    public function getCurrentTranslation(PropelPDO $con = null)
    {
         ...
         *
         * @param string $v new value
         * @return DepartementI18n The current object (for fluent API support)
         */
