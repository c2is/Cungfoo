...
abstract class BaseCategoryTypeHebergementI18n extends BaseObject implements Persistent
{
    ...
    public function setAccroche($v)
    {
        ...
        if ($this->accroche !== $v) {
            $this->accroche = $v;
            $this->modifiedColumns[] = CategoryTypeHebergementI18nPeer::ACCROCHE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = CategoryTypeHebergementI18nPeer::DESCRIPTION;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = CategoryTypeHebergementI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = CategoryTypeHebergementI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = CategoryTypeHebergementI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = CategoryTypeHebergementI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = CategoryTypeHebergementI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 11; // 11 = CategoryTypeHebergementI18nPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::ACCROCHE)) {
            $modifiedColumns[':p' . $index++]  = '`accroche`';
        }
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::ACTIVE_LOCALE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::ACCROCHE)) $criteria->add(CategoryTypeHebergementI18nPeer::ACCROCHE, $this->accroche);
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::DESCRIPTION)) $criteria->add(CategoryTypeHebergementI18nPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::SEO_TITLE)) $criteria->add(CategoryTypeHebergementI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::SEO_DESCRIPTION)) $criteria->add(CategoryTypeHebergementI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::SEO_H1)) $criteria->add(CategoryTypeHebergementI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::SEO_KEYWORDS)) $criteria->add(CategoryTypeHebergementI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
        if ($this->isColumnModified(CategoryTypeHebergementI18nPeer::ACTIVE_LOCALE)) $criteria->add(CategoryTypeHebergementI18nPeer::ACTIVE_LOCALE, $this->active_locale);
