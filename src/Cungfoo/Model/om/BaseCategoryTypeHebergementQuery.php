 ...
 * @method CategoryTypeHebergementQuery orderByName($order = Criteria::ASC) Order by the name column
 ...
 * @method CategoryTypeHebergementQuery groupByName() Group by the name column
 ...
 *
 * @method CategoryTypeHebergement findOneByName(string $name) Return the first CategoryTypeHebergement filtered by the name column
 ...
 * @method array findByName(string $name) Return CategoryTypeHebergement objects filtered by the name column
...
abstract class BaseCategoryTypeHebergementQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `NAME`, `CREATED_AT`, `UPDATED_AT` FROM `category_type_hebergement` WHERE `ID` = :p0';
        try {
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryTypeHebergementPeer::NAME, $name, $comparison);
    }
