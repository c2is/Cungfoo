 ...
 */
abstract class BaseEditoI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\EditoI18nPeer';
    ...
    /**
     * Initializes internal state of BaseEditoI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = EditoI18nPeer::ID;
        }

        if ($this->aEdito !== null && $this->aEdito->getId() !== $v) {
            $this->aEdito = null;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = EditoI18nPeer::LOCALE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = EditoI18nPeer::NAME;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = EditoI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = EditoI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = EditoI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = EditoI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = EditoI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 9; // 9 = EditoI18nPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aEdito !== null && $this->id !== $this->aEdito->getId()) {
            $this->aEdito = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EditoI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EditoI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EditoI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aEdito !== null) {
                if ($this->aEdito->isModified() || $this->aEdito->isNew()) {
                    $affectedRows += $this->aEdito->save($con);
                }
                $this->setEdito($this->aEdito);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EditoI18nPeer::ID)) {
        ...
        if ($this->isColumnModified(EditoI18nPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(EditoI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(EditoI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(EditoI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(EditoI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }
        if ($this->isColumnModified(EditoI18nPeer::ACTIVE_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`active_locale`';
        }

        $sql = sprintf(
            'INSERT INTO `edito_i18n` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aEdito !== null) {
                if (!$this->aEdito->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aEdito->getValidationFailures());
                }
            }


            if (($retval = EditoI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EditoI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['EditoI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EditoI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = EditoI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aEdito) {
                $result['Edito'] = $this->aEdito->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EditoI18nPeer::SEO_TITLE)) $criteria->add(EditoI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(EditoI18nPeer::SEO_DESCRIPTION)) $criteria->add(EditoI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(EditoI18nPeer::SEO_H1)) $criteria->add(EditoI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(EditoI18nPeer::SEO_KEYWORDS)) $criteria->add(EditoI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
        if ($this->isColumnModified(EditoI18nPeer::ACTIVE_LOCALE)) $criteria->add(EditoI18nPeer::ACTIVE_LOCALE, $this->active_locale);
    ...
    {
        $criteria = new Criteria(EditoI18nPeer::DATABASE_NAME);
        $criteria->add(EditoI18nPeer::ID, $this->id);
        $criteria->add(EditoI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of EditoI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EditoI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EditoI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EditoI18nPeer();
        }
    ...
    /**
     * Declares an association between this object and a Edito object.
     *
     * @param             Edito $v
     * @return EditoI18n The current object (for fluent API support)
     * @throws PropelException
     */
    public function setEdito(Edito $v = null)
    {
        if ($v === null) {
            $this->setId(NULL);
        } else {
        ...
        // If this object has already been added to the Edito object, it will not be re-added.
        if ($v !== null) {
            $v->addEditoI18n($this);
        }
    ...
    /**
     * Get the associated Edito object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Edito The associated Edito object.
     * @throws PropelException
     */
    public function getEdito(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEdito === null && ($this->id !== null) && $doQuery) {
            $this->aEdito = EditoQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEdito->addEditoI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(EditoI18nPeer::DEFAULT_STRING_FORMAT);
    }
