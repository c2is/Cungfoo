...
use Cungfoo\Model\map\NewsletterTableMap;
...
abstract class BaseNewsletterPeer
{
    ...
    const OM_CLASS = 'Cungfoo\\Model\\Newsletter';
    ...
    const ACTIVE = 'newsletter.active';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Email', 'CreatedAt', 'UpdatedAt', 'Active', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'email', 'createdAt', 'updatedAt', 'active', ),
        BasePeer::TYPE_COLNAME => array (NewsletterPeer::ID, NewsletterPeer::EMAIL, NewsletterPeer::CREATED_AT, NewsletterPeer::UPDATED_AT, NewsletterPeer::ACTIVE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'EMAIL', 'CREATED_AT', 'UPDATED_AT', 'ACTIVE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'email', 'created_at', 'updated_at', 'active', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Email' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, 'Active' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'email' => 1, 'createdAt' => 2, 'updatedAt' => 3, 'active' => 4, ),
        BasePeer::TYPE_COLNAME => array (NewsletterPeer::ID => 0, NewsletterPeer::EMAIL => 1, NewsletterPeer::CREATED_AT => 2, NewsletterPeer::UPDATED_AT => 3, NewsletterPeer::ACTIVE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'EMAIL' => 1, 'CREATED_AT' => 2, 'UPDATED_AT' => 3, 'ACTIVE' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'email' => 1, 'created_at' => 2, 'updated_at' => 3, 'active' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NewsletterPeer::ACTIVE);
        } else {
    ...
    {
        // Invalidate objects in NewsletterI18nPeer instance pool,
    ...
    public static function getMetadata($locale = 'fr', PropelPDO $con = null)
    {
        return \Cungfoo\Model\MetadataQuery::create()
            ->joinWithI18n($locale)
            ->filterByTableRef(NewsletterPeer::TABLE_NAME)
            ->findOne()
        ;
    }
    // seo behavior
