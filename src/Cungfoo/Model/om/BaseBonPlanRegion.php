...
/**
 * Base class that represents a row from the 'bon_plan_region' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseBonPlanRegion extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\BonPlanRegionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BonPlanRegionPeer
     */
     ...
     * @return BonPlanRegion The current object (for fluent API support)
     */
    public function setBonPlanId($v)
    {
        ...
        if ($this->bon_plan_id !== $v) {
            $this->bon_plan_id = $v;
            $this->modifiedColumns[] = BonPlanRegionPeer::BON_PLAN_ID;
        }
    ...
    public function setRegionId($v)
    {
        ...
        if ($this->region_id !== $v) {
            $this->region_id = $v;
            $this->modifiedColumns[] = BonPlanRegionPeer::REGION_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = BonPlanRegionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BonPlanRegion object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BonPlanRegionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BonPlanRegionQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BonPlanRegionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BonPlanRegionPeer::BON_PLAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bon_plan_id`';
        }
        if ($this->isColumnModified(BonPlanRegionPeer::REGION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`region_id`';
        }

        $sql = sprintf(
            'INSERT INTO `bon_plan_region` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BonPlanRegionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BonPlanRegionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BonPlanRegion'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BonPlanRegion'][serialize($this->getPrimaryKey())] = true;
        $keys = BonPlanRegionPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BonPlanRegionPeer::BON_PLAN_ID)) $criteria->add(BonPlanRegionPeer::BON_PLAN_ID, $this->bon_plan_id);
        if ($this->isColumnModified(BonPlanRegionPeer::REGION_ID)) $criteria->add(BonPlanRegionPeer::REGION_ID, $this->region_id);
    ...
    {
        $criteria = new Criteria(BonPlanRegionPeer::DATABASE_NAME);
        $criteria->add(BonPlanRegionPeer::BON_PLAN_ID, $this->bon_plan_id);
        $criteria->add(BonPlanRegionPeer::REGION_ID, $this->region_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getBonPlanId()) && (null === $this->getRegionId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of BonPlanRegion (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BonPlanRegion Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BonPlanRegionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BonPlanRegionPeer();
        }
    ...
    public function getBonPlan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBonPlan === null && ($this->bon_plan_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBonPlan->addBonPlanRegions($this);
             */
        }
    ...
    public function getRegion(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRegion === null && ($this->region_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRegion->addBonPlanRegions($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BonPlanRegionPeer::DEFAULT_STRING_FORMAT);
    }
