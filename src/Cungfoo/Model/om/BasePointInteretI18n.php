...
/**
 * Base class that represents a row from the 'point_interet_i18n' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BasePointInteretI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\PointInteretI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PointInteretI18nPeer
     */
    ...
    /**
     * Initializes internal state of BasePointInteretI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PointInteretI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = PointInteretI18nPeer::LOCALE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = PointInteretI18nPeer::NAME;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = PointInteretI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = PointInteretI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = PointInteretI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = PointInteretI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = PointInteretI18nPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPointInteret !== null && $this->id !== $this->aPointInteret->getId()) {
            $this->aPointInteret = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PointInteretI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PointInteretI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PointInteretI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PointInteretI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(PointInteretI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(PointInteretI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(PointInteretI18nPeer::SEO_KEYWORDS)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PointInteretI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PointInteretI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PointInteretI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PointInteretI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = PointInteretI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PointInteretI18nPeer::SEO_TITLE)) $criteria->add(PointInteretI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(PointInteretI18nPeer::SEO_DESCRIPTION)) $criteria->add(PointInteretI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(PointInteretI18nPeer::SEO_H1)) $criteria->add(PointInteretI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(PointInteretI18nPeer::SEO_KEYWORDS)) $criteria->add(PointInteretI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
    ...
    {
        $criteria = new Criteria(PointInteretI18nPeer::DATABASE_NAME);
        $criteria->add(PointInteretI18nPeer::ID, $this->id);
        $criteria->add(PointInteretI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of PointInteretI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PointInteretI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PointInteretI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PointInteretI18nPeer();
        }
    ...
    public function getPointInteret(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPointInteret === null && ($this->id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPointInteret->addPointInteretI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PointInteretI18nPeer::DEFAULT_STRING_FORMAT);
    }
