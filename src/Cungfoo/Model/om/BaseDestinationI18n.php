...
/**
 * Base class that represents a row from the 'destination_i18n' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseDestinationI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\DestinationI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DestinationI18nPeer
     */
    ...
    /**
     * Initializes internal state of BaseDestinationI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DestinationI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = DestinationI18nPeer::LOCALE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = DestinationI18nPeer::NAME;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = DestinationI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = DestinationI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = DestinationI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aDestination !== null && $this->id !== $this->aDestination->getId()) {
            $this->aDestination = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DestinationI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DestinationI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DestinationI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DestinationI18nPeer::ID)) {
        ...
        if ($this->isColumnModified(DestinationI18nPeer::SEO_TITLE)) {
        ...
        if ($this->isColumnModified(DestinationI18nPeer::ACTIVE_LOCALE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DestinationI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DestinationI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['DestinationI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DestinationI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = DestinationI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(DestinationI18nPeer::DATABASE_NAME);
        $criteria->add(DestinationI18nPeer::ID, $this->id);
        $criteria->add(DestinationI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of DestinationI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return DestinationI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DestinationI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DestinationI18nPeer();
        }
    ...
    {
        if ($this->aDestination === null && ($this->id !== null) && $doQuery) {
            $this->aDestination = DestinationQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDestination->addDestinationI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DestinationI18nPeer::DEFAULT_STRING_FORMAT);
    }
