...
/**
 * Base class that represents a row from the 'document_author' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseDocumentAuthor extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\DocumentAuthorPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DocumentAuthorPeer
     */
     ...
     * @return DocumentAuthor The current object (for fluent API support)
     */
    public function setDocumentId($v)
    {
        ...
        if ($this->document_id !== $v) {
            $this->document_id = $v;
            $this->modifiedColumns[] = DocumentAuthorPeer::DOCUMENT_ID;
        }
    ...
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[] = DocumentAuthorPeer::AUTHOR_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = DocumentAuthorPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating DocumentAuthor object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DocumentAuthorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DocumentAuthorQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DocumentAuthorPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DocumentAuthorPeer::DOCUMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`DOCUMENT_ID`';
        }
        if ($this->isColumnModified(DocumentAuthorPeer::AUTHOR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`AUTHOR_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `document_author` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DocumentAuthorPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DocumentAuthorPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['DocumentAuthor'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DocumentAuthor'][serialize($this->getPrimaryKey())] = true;
        $keys = DocumentAuthorPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DocumentAuthorPeer::DOCUMENT_ID)) $criteria->add(DocumentAuthorPeer::DOCUMENT_ID, $this->document_id);
        if ($this->isColumnModified(DocumentAuthorPeer::AUTHOR_ID)) $criteria->add(DocumentAuthorPeer::AUTHOR_ID, $this->author_id);
    ...
    {
        $criteria = new Criteria(DocumentAuthorPeer::DATABASE_NAME);
        $criteria->add(DocumentAuthorPeer::DOCUMENT_ID, $this->document_id);
        $criteria->add(DocumentAuthorPeer::AUTHOR_ID, $this->author_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getDocumentId()) && (null === $this->getAuthorId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of DocumentAuthor (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return DocumentAuthor Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DocumentAuthorPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DocumentAuthorPeer();
        }
    ...
    public function getDocument(PropelPDO $con = null)
    {
        if ($this->aDocument === null && ($this->document_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDocument->addDocumentAuthors($this);
             */
        }
    ...
    public function getAuthor(PropelPDO $con = null)
    {
        if ($this->aAuthor === null && ($this->author_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthor->addDocumentAuthors($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DocumentAuthorPeer::DEFAULT_STRING_FORMAT);
    }
