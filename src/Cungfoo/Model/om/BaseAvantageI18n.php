...
abstract class BaseAvantageI18n extends BaseObject implements Persistent
{
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = AvantageI18nPeer::ACTIVE_LOCALE;
        }
     ...
     * @throws PropelException
     */
    public function getAvantage(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAvantage === null && ($this->id !== null) && $doQuery) {
