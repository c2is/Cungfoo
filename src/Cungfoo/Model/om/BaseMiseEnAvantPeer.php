...
abstract class BaseMiseEnAvantPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ImageFondPath', 'IllustrationPath', 'DateFinValidite', 'SortableRank', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'imageFondPath', 'illustrationPath', 'dateFinValidite', 'sortableRank', ),
        BasePeer::TYPE_COLNAME => array (MiseEnAvantPeer::ID, MiseEnAvantPeer::IMAGE_FOND_PATH, MiseEnAvantPeer::ILLUSTRATION_PATH, MiseEnAvantPeer::DATE_FIN_VALIDITE, MiseEnAvantPeer::SORTABLE_RANK, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'IMAGE_FOND_PATH', 'ILLUSTRATION_PATH', 'DATE_FIN_VALIDITE', 'SORTABLE_RANK', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'image_fond_path', 'illustration_path', 'date_fin_validite', 'sortable_rank', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ImageFondPath' => 1, 'IllustrationPath' => 2, 'DateFinValidite' => 3, 'SortableRank' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'imageFondPath' => 1, 'illustrationPath' => 2, 'dateFinValidite' => 3, 'sortableRank' => 4, ),
        BasePeer::TYPE_COLNAME => array (MiseEnAvantPeer::ID => 0, MiseEnAvantPeer::IMAGE_FOND_PATH => 1, MiseEnAvantPeer::ILLUSTRATION_PATH => 2, MiseEnAvantPeer::DATE_FIN_VALIDITE => 3, MiseEnAvantPeer::SORTABLE_RANK => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'IMAGE_FOND_PATH' => 1, 'ILLUSTRATION_PATH' => 2, 'DATE_FIN_VALIDITE' => 3, 'SORTABLE_RANK' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'image_fond_path' => 1, 'illustration_path' => 2, 'date_fin_validite' => 3, 'sortable_rank' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
