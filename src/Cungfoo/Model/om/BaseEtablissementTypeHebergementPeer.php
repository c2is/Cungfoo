 ...
 */
abstract class BaseEtablissementTypeHebergementPeer
{
    ...
    const TABLE_NAME = 'etablissement_type_hebergement';

    /** the related Propel class for this table */
    const OM_CLASS = 'Cungfoo\\Model\\EtablissementTypeHebergement';
    ...
    /**
     * An identiy map to hold any loaded instances of EtablissementTypeHebergement objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array EtablissementTypeHebergement[]
     */
    ...
    {
        $toNames = EtablissementTypeHebergementPeer::getFieldNames($toType);
        $key = isset(EtablissementTypeHebergementPeer::$fieldKeys[$fromType][$name]) ? EtablissementTypeHebergementPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(EtablissementTypeHebergementPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, EtablissementTypeHebergementPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return EtablissementTypeHebergementPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. EtablissementTypeHebergementPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(EtablissementTypeHebergementPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(EtablissementTypeHebergementPeer::TABLE_NAME);
        ...
        $criteria->setDbName(EtablissementTypeHebergementPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = EtablissementTypeHebergementPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return EtablissementTypeHebergementPeer::populateObjects(EtablissementTypeHebergementPeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param      EtablissementTypeHebergement $obj A EtablissementTypeHebergement object.
     ...
     *
     * @param      mixed $value A EtablissementTypeHebergement object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(EtablissementTypeHebergementPeer::$instances[$key]);
        }
     ...
     * @return   EtablissementTypeHebergement Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(EtablissementTypeHebergementPeer::$instances[$key])) {
                return EtablissementTypeHebergementPeer::$instances[$key];
            }
        }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = EtablissementTypeHebergementPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = EtablissementTypeHebergementPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                EtablissementTypeHebergementPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (EtablissementTypeHebergement object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = EtablissementTypeHebergementPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = EtablissementTypeHebergementPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + EtablissementTypeHebergementPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = EtablissementTypeHebergementPeer::OM_CLASS;
            $obj = new $cls();
    ...
    /**
     * Selects a collection of EtablissementTypeHebergement objects pre-filled with their Etablissement objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of EtablissementTypeHebergement objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinEtablissement(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        EtablissementTypeHebergementPeer::addSelectColumns($criteria);
        $startcol = EtablissementTypeHebergementPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = EtablissementTypeHebergementPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = EtablissementTypeHebergementPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                EtablissementTypeHebergementPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (EtablissementTypeHebergement) to $obj2 (Etablissement)
                $obj2->addEtablissementTypeHebergement($obj1);
    ...
    /**
     * Selects a collection of EtablissementTypeHebergement objects pre-filled with their TypeHebergement objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of EtablissementTypeHebergement objects.
    ...
    public static function doSelectJoinTypeHebergement(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (EtablissementTypeHebergement) to $obj2 (TypeHebergement)
                $obj2->addEtablissementTypeHebergement($obj1);
    ...
    /**
     * Selects a collection of EtablissementTypeHebergement objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        EtablissementTypeHebergementPeer::addSelectColumns($criteria);
        $startcol2 = EtablissementTypeHebergementPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (EtablissementTypeHebergement) to the collection in $obj2 (Etablissement)
                $obj2->addEtablissementTypeHebergement($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (EtablissementTypeHebergement) to the collection in $obj3 (TypeHebergement)
                $obj3->addEtablissementTypeHebergement($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of EtablissementTypeHebergement objects pre-filled with all related objects except Etablissement.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptEtablissement(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = EtablissementTypeHebergementPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (EtablissementTypeHebergement) to the collection in $obj2 (TypeHebergement)
                $obj2->addEtablissementTypeHebergement($obj1);
    ...
    /**
     * Selects a collection of EtablissementTypeHebergement objects pre-filled with all related objects except TypeHebergement.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(EtablissementTypeHebergementPeer::DATABASE_NAME)->getTable(EtablissementTypeHebergementPeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseEtablissementTypeHebergementPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseEtablissementTypeHebergementPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new EtablissementTypeHebergementTableMap());
      }
    }
    ...
    {
        return EtablissementTypeHebergementPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a EtablissementTypeHebergement or Criteria object.
     *
     * @param      mixed $values Criteria or EtablissementTypeHebergement object containing data that is used to create the INSERT statement.
    ...
    /**
     * Performs an UPDATE on the database, given a EtablissementTypeHebergement or Criteria object.
     *
     * @param      mixed $values Criteria or EtablissementTypeHebergement object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(EtablissementTypeHebergementPeer::DATABASE_NAME);
        ...
        } else { // $values is EtablissementTypeHebergement object
    ...
    /**
     * Deletes all rows from the etablissement_type_hebergement table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(EtablissementTypeHebergementPeer::TABLE_NAME, $con, EtablissementTypeHebergementPeer::DATABASE_NAME);
    ...
    /**
     * Performs a DELETE on the database, given a EtablissementTypeHebergement or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or EtablissementTypeHebergement object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof EtablissementTypeHebergement) { // it's a model object
            // invalidate the cache for this single object
            EtablissementTypeHebergementPeer::removeInstanceFromPool($values);
    ...
    /**
     * Validates all modified columns of given EtablissementTypeHebergement object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      EtablissementTypeHebergement $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(EtablissementTypeHebergementPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(EtablissementTypeHebergementPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(EtablissementTypeHebergementPeer::DATABASE_NAME, EtablissementTypeHebergementPeer::TABLE_NAME, $columns);
    }
...
//
BaseEtablissementTypeHebergementPeer::buildTableMap();
