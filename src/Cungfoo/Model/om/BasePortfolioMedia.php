...
abstract class BasePortfolioMedia extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the name_origin field.
     * @var        string
     */
    ...
    /**
     * The value for the path_origin field.
     * @var        string
     */
    protected $path_origin;

    /**
     * The value for the path_miniature field.
     * @var        string
     */
    protected $path_miniature;
    ...
    /**
     * Get the [name_origin] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [path_origin] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [path_miniature] column value.
     *
     * @return string
     */
    public function getPathMiniature()
    {
        return $this->path_miniature;
    }
    ...
    /**
     * Set the value of [name_origin] column.
     *
     * @param string $v new value
     * @return PortfolioMedia The current object (for fluent API support)
     */
    public function setNameOrigin($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->name_origin !== $v) {
            $this->name_origin = $v;
            $this->modifiedColumns[] = PortfolioMediaPeer::NAME_ORIGIN;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = PortfolioMediaPeer::NAME;
        }
    ...
    /**
     * Set the value of [path_origin] column.
     *
     * @param string $v new value
     * @return PortfolioMedia The current object (for fluent API support)
     */
    public function setPathOrigin($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->path_origin !== $v) {
            $this->path_origin = $v;
            $this->modifiedColumns[] = PortfolioMediaPeer::PATH_ORIGIN;
        }
    ...
    /**
     * Set the value of [path_miniature] column.
     *
     * @param string $v new value
     * @return PortfolioMedia The current object (for fluent API support)
     */
    public function setPathMiniature($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->path_miniature !== $v) {
            $this->path_miniature = $v;
            $this->modifiedColumns[] = PortfolioMediaPeer::PATH_MINIATURE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->name_origin = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->description = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->path_origin = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->path_miniature = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            ...
            return $startcol + 10; // 10 = PortfolioMediaPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PortfolioMediaPeer::NAME_ORIGIN)) {
            $modifiedColumns[':p' . $index++]  = '`NAME_ORIGIN`';
        }
        if ($this->isColumnModified(PortfolioMediaPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`NAME`';
        }
        if ($this->isColumnModified(PortfolioMediaPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPTION`';
        }
        if ($this->isColumnModified(PortfolioMediaPeer::PATH_ORIGIN)) {
            $modifiedColumns[':p' . $index++]  = '`PATH_ORIGIN`';
        }
        if ($this->isColumnModified(PortfolioMediaPeer::PATH_MINIATURE)) {
            $modifiedColumns[':p' . $index++]  = '`PATH_MINIATURE`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`ID`':
                        ...
                        break;
                    case '`NAME_ORIGIN`':
                        $stmt->bindValue($identifier, $this->name_origin, PDO::PARAM_STR);
                        break;
                    case '`NAME`':
                    ...
                    case '`DESCRIPTION`':
                        ...
                        break;
                    case '`PATH_ORIGIN`':
                        $stmt->bindValue($identifier, $this->path_origin, PDO::PARAM_STR);
                        break;
                    case '`PATH_MINIATURE`':
                        $stmt->bindValue($identifier, $this->path_miniature, PDO::PARAM_STR);
                        break;
                    case '`SIZE`':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                return $this->getPathOrigin();
                break;
            case 5:
                return $this->getPathMiniature();
                break;
            case 6:
                return $this->getSize();
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNameOrigin(),
            $keys[2] => $this->getName(),
            $keys[3] => $this->getDescription(),
            $keys[4] => $this->getPathOrigin(),
            $keys[5] => $this->getPathMiniature(),
            $keys[6] => $this->getSize(),
            $keys[7] => $this->getType(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                $this->setPathOrigin($value);
                break;
            case 5:
                $this->setPathMiniature($value);
                break;
            case 6:
                $this->setSize($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setNameOrigin($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setName($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setDescription($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setPathOrigin($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setPathMiniature($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PortfolioMediaPeer::NAME_ORIGIN)) $criteria->add(PortfolioMediaPeer::NAME_ORIGIN, $this->name_origin);
        if ($this->isColumnModified(PortfolioMediaPeer::NAME)) $criteria->add(PortfolioMediaPeer::NAME, $this->name);
        if ($this->isColumnModified(PortfolioMediaPeer::DESCRIPTION)) $criteria->add(PortfolioMediaPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PortfolioMediaPeer::PATH_ORIGIN)) $criteria->add(PortfolioMediaPeer::PATH_ORIGIN, $this->path_origin);
        if ($this->isColumnModified(PortfolioMediaPeer::PATH_MINIATURE)) $criteria->add(PortfolioMediaPeer::PATH_MINIATURE, $this->path_miniature);
    ...
    {
        $copyObj->setNameOrigin($this->getNameOrigin());
        $copyObj->setName($this->getName());
        $copyObj->setDescription($this->getDescription());
        $copyObj->setPathOrigin($this->getPathOrigin());
        $copyObj->setPathMiniature($this->getPathMiniature());
    ...
    {
        $this->id = null;
        $this->name_origin = null;
        $this->name = null;
        $this->description = null;
        $this->path_origin = null;
        $this->path_miniature = null;
        $this->size = null;
        $this->type = null;
