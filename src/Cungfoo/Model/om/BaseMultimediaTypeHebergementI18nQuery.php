...
abstract class BaseMultimediaTypeHebergementI18nQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `locale`, `titre`, `seo_title`, `seo_description`, `seo_h1`, `seo_keywords`, `active_locale` FROM `multimedia_type_hebergement_i18n` WHERE `id` = :p0 AND `locale` = :p1';
        try {
