...
abstract class BaseAvantageQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `PERSONNAGE_ID`, `IMAGE_PATH`, `CREATED_AT`, `UPDATED_AT`, `ACTIVE`, `ENABLED` FROM `avantage` WHERE `ID` = :p0';
        try {
    ...
    public function filterByImagePath($imagePath = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AvantagePeer::IMAGE_PATH, $imagePath, $comparison);
    }
