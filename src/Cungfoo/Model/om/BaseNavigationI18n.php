...
/**
 * Base class that represents a row from the 'navigation_i18n' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseNavigationI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\NavigationI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        NavigationI18nPeer
     */
    ...
    /**
     * Initializes internal state of BaseNavigationI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = NavigationI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = NavigationI18nPeer::LOCALE;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = NavigationI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = NavigationI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = NavigationI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = NavigationI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = NavigationI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = NavigationI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating NavigationI18n object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aNavigation !== null && $this->id !== $this->aNavigation->getId()) {
            $this->aNavigation = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = NavigationI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = NavigationI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                NavigationI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NavigationI18nPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(NavigationI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(NavigationI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(NavigationI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(NavigationI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(NavigationI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }
        if ($this->isColumnModified(NavigationI18nPeer::ACTIVE_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`active_locale`';
        }

        $sql = sprintf(
            'INSERT INTO `navigation_i18n` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = NavigationI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = NavigationI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['NavigationI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['NavigationI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = NavigationI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NavigationI18nPeer::ID)) $criteria->add(NavigationI18nPeer::ID, $this->id);
        if ($this->isColumnModified(NavigationI18nPeer::LOCALE)) $criteria->add(NavigationI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(NavigationI18nPeer::SEO_TITLE)) $criteria->add(NavigationI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(NavigationI18nPeer::SEO_DESCRIPTION)) $criteria->add(NavigationI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(NavigationI18nPeer::SEO_H1)) $criteria->add(NavigationI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(NavigationI18nPeer::SEO_KEYWORDS)) $criteria->add(NavigationI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
        if ($this->isColumnModified(NavigationI18nPeer::ACTIVE_LOCALE)) $criteria->add(NavigationI18nPeer::ACTIVE_LOCALE, $this->active_locale);
    ...
    {
        $criteria = new Criteria(NavigationI18nPeer::DATABASE_NAME);
        $criteria->add(NavigationI18nPeer::ID, $this->id);
        $criteria->add(NavigationI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of NavigationI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return NavigationI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return NavigationI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new NavigationI18nPeer();
        }
    ...
    {
        if ($this->aNavigation === null && ($this->id !== null) && $doQuery) {
            $this->aNavigation = NavigationQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aNavigation->addNavigationI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(NavigationI18nPeer::DEFAULT_STRING_FORMAT);
    }
