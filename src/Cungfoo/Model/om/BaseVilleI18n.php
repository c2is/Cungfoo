 ...
 */
abstract class BaseVilleI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\VilleI18nPeer';
    ...
    /**
     * Initializes internal state of BaseVilleI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = VilleI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = VilleI18nPeer::LOCALE;
        }
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = VilleI18nPeer::SLUG;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = VilleI18nPeer::NAME;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = VilleI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = VilleI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = VilleI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = VilleI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = VilleI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 11; // 11 = VilleI18nPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aVille !== null && $this->id !== $this->aVille->getId()) {
            $this->aVille = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VilleI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VilleI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VilleI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VilleI18nPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(VilleI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(VilleI18nPeer::SLUG)) {
        ...
        if ($this->isColumnModified(VilleI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(VilleI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(VilleI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(VilleI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }
        if ($this->isColumnModified(VilleI18nPeer::ACTIVE_LOCALE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VilleI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VilleI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VilleI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VilleI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = VilleI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VilleI18nPeer::SLUG)) $criteria->add(VilleI18nPeer::SLUG, $this->slug);
        ...
        if ($this->isColumnModified(VilleI18nPeer::SEO_TITLE)) $criteria->add(VilleI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(VilleI18nPeer::SEO_DESCRIPTION)) $criteria->add(VilleI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(VilleI18nPeer::SEO_H1)) $criteria->add(VilleI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(VilleI18nPeer::SEO_KEYWORDS)) $criteria->add(VilleI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
        if ($this->isColumnModified(VilleI18nPeer::ACTIVE_LOCALE)) $criteria->add(VilleI18nPeer::ACTIVE_LOCALE, $this->active_locale);
    ...
    {
        $criteria = new Criteria(VilleI18nPeer::DATABASE_NAME);
        $criteria->add(VilleI18nPeer::ID, $this->id);
        $criteria->add(VilleI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of VilleI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VilleI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VilleI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VilleI18nPeer();
        }
    ...
    {
        if ($this->aVille === null && ($this->id !== null) && $doQuery) {
            $this->aVille = VilleQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVille->addVilleI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VilleI18nPeer::DEFAULT_STRING_FORMAT);
    }
