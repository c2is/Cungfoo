...
/**
 * Base class that represents a row from the 'bon_plan_type_hebergement' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseBonPlanTypeHebergement extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\BonPlanTypeHebergementPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BonPlanTypeHebergementPeer
     */
     ...
     * @return BonPlanTypeHebergement The current object (for fluent API support)
     */
    public function setBonPlanId($v)
    {
        ...
        if ($this->bon_plan_id !== $v) {
            $this->bon_plan_id = $v;
            $this->modifiedColumns[] = BonPlanTypeHebergementPeer::BON_PLAN_ID;
        }
    ...
    public function setTypeHebergementId($v)
    {
        ...
        if ($this->type_hebergement_id !== $v) {
            ...
            $this->modifiedColumns[] = BonPlanTypeHebergementPeer::TYPE_HEBERGEMENT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = BonPlanTypeHebergementPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BonPlanTypeHebergement object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BonPlanTypeHebergementPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BonPlanTypeHebergementQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BonPlanTypeHebergementPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BonPlanTypeHebergementPeer::BON_PLAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bon_plan_id`';
        }
        if ($this->isColumnModified(BonPlanTypeHebergementPeer::TYPE_HEBERGEMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`type_hebergement_id`';
        }

        $sql = sprintf(
            'INSERT INTO `bon_plan_type_hebergement` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BonPlanTypeHebergementPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BonPlanTypeHebergementPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BonPlanTypeHebergement'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BonPlanTypeHebergement'][serialize($this->getPrimaryKey())] = true;
        $keys = BonPlanTypeHebergementPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BonPlanTypeHebergementPeer::BON_PLAN_ID)) $criteria->add(BonPlanTypeHebergementPeer::BON_PLAN_ID, $this->bon_plan_id);
        if ($this->isColumnModified(BonPlanTypeHebergementPeer::TYPE_HEBERGEMENT_ID)) $criteria->add(BonPlanTypeHebergementPeer::TYPE_HEBERGEMENT_ID, $this->type_hebergement_id);
    ...
    {
        $criteria = new Criteria(BonPlanTypeHebergementPeer::DATABASE_NAME);
        $criteria->add(BonPlanTypeHebergementPeer::BON_PLAN_ID, $this->bon_plan_id);
        $criteria->add(BonPlanTypeHebergementPeer::TYPE_HEBERGEMENT_ID, $this->type_hebergement_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getBonPlanId()) && (null === $this->getTypeHebergementId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of BonPlanTypeHebergement (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BonPlanTypeHebergement Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BonPlanTypeHebergementPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BonPlanTypeHebergementPeer();
        }
    ...
    public function setBonPlan(BonPlan $v = null)
    {
        ...
        if ($v !== null) {
            $v->addBonPlanTypeHebergement($this);
        }
    ...
    public function getBonPlan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBonPlan === null && ($this->bon_plan_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBonPlan->addBonPlanTypeHebergements($this);
             */
        }
    ...
    public function getTypeHebergement(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTypeHebergement === null && ($this->type_hebergement_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTypeHebergement->addBonPlanTypeHebergements($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BonPlanTypeHebergementPeer::DEFAULT_STRING_FORMAT);
    }
