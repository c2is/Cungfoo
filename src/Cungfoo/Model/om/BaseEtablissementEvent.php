 ...
 */
abstract class BaseEtablissementEvent extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\EtablissementEventPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EtablissementEventPeer
     */
    ...
    public function setEtablissementId($v)
    {
        ...
        if ($this->etablissement_id !== $v) {
            ...
            $this->modifiedColumns[] = EtablissementEventPeer::ETABLISSEMENT_ID;
        }
    ...
    public function setEventId($v)
    {
        ...
        if ($this->event_id !== $v) {
            $this->event_id = $v;
            $this->modifiedColumns[] = EtablissementEventPeer::EVENT_ID;
        }
    ...
    public function setDistance($v)
    {
        ...
        if ($this->distance !== $v) {
            $this->distance = $v;
            $this->modifiedColumns[] = EtablissementEventPeer::DISTANCE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            throw new PropelException("Error populating EtablissementEvent object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EtablissementEventPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EtablissementEventQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EtablissementEventPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `etablissement_event` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EtablissementEventPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EtablissementEventPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['EtablissementEvent'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EtablissementEvent'][serialize($this->getPrimaryKey())] = true;
        $keys = EtablissementEventPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EtablissementEventPeer::ETABLISSEMENT_ID)) $criteria->add(EtablissementEventPeer::ETABLISSEMENT_ID, $this->etablissement_id);
        if ($this->isColumnModified(EtablissementEventPeer::EVENT_ID)) $criteria->add(EtablissementEventPeer::EVENT_ID, $this->event_id);
        if ($this->isColumnModified(EtablissementEventPeer::DISTANCE)) $criteria->add(EtablissementEventPeer::DISTANCE, $this->distance);
    ...
    {
        $criteria = new Criteria(EtablissementEventPeer::DATABASE_NAME);
        $criteria->add(EtablissementEventPeer::ETABLISSEMENT_ID, $this->etablissement_id);
        $criteria->add(EtablissementEventPeer::EVENT_ID, $this->event_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getEtablissementId()) && (null === $this->getEventId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of EtablissementEvent (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EtablissementEvent Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EtablissementEventPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EtablissementEventPeer();
        }
    ...
    public function getEtablissement(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEtablissement === null && ($this->etablissement_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEtablissement->addEtablissementEvents($this);
             */
        }
    ...
    public function getEvent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEvent === null && ($this->event_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEvent->addEtablissementEvents($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(EtablissementEventPeer::DEFAULT_STRING_FORMAT);
    }
