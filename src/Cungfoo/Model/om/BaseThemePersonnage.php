...
/**
 * Base class that represents a row from the 'theme_personnage' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseThemePersonnage extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\ThemePersonnagePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ThemePersonnagePeer
     */
     ...
     * @return ThemePersonnage The current object (for fluent API support)
     */
    public function setThemeId($v)
    {
        ...
        if ($this->theme_id !== $v) {
            $this->theme_id = $v;
            $this->modifiedColumns[] = ThemePersonnagePeer::THEME_ID;
        }
    ...
    public function setPersonnageId($v)
    {
        ...
        if ($this->personnage_id !== $v) {
            ...
            $this->modifiedColumns[] = ThemePersonnagePeer::PERSONNAGE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ThemePersonnagePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ThemePersonnage object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ThemePersonnagePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ThemePersonnageQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ThemePersonnagePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ThemePersonnagePeer::THEME_ID)) {
            $modifiedColumns[':p' . $index++]  = '`theme_id`';
        }
        if ($this->isColumnModified(ThemePersonnagePeer::PERSONNAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`personnage_id`';
        }

        $sql = sprintf(
            'INSERT INTO `theme_personnage` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ThemePersonnagePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ThemePersonnagePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ThemePersonnage'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ThemePersonnage'][serialize($this->getPrimaryKey())] = true;
        $keys = ThemePersonnagePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ThemePersonnagePeer::THEME_ID)) $criteria->add(ThemePersonnagePeer::THEME_ID, $this->theme_id);
        if ($this->isColumnModified(ThemePersonnagePeer::PERSONNAGE_ID)) $criteria->add(ThemePersonnagePeer::PERSONNAGE_ID, $this->personnage_id);
    ...
    {
        $criteria = new Criteria(ThemePersonnagePeer::DATABASE_NAME);
        $criteria->add(ThemePersonnagePeer::THEME_ID, $this->theme_id);
        $criteria->add(ThemePersonnagePeer::PERSONNAGE_ID, $this->personnage_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getThemeId()) && (null === $this->getPersonnageId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ThemePersonnage (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ThemePersonnage Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ThemePersonnagePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ThemePersonnagePeer();
        }
    ...
    public function getTheme(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTheme === null && ($this->theme_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTheme->addThemePersonnages($this);
             */
        }
    ...
    public function getPersonnage(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPersonnage === null && ($this->personnage_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPersonnage->addThemePersonnages($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ThemePersonnagePeer::DEFAULT_STRING_FORMAT);
    }
