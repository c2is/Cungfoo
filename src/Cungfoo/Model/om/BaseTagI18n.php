 ...
 */
abstract class BaseTagI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\TagI18nPeer';
    ...
    /**
     * Initializes internal state of BaseTagI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = TagI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = TagI18nPeer::LOCALE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = TagI18nPeer::NAME;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = TagI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = TagI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = TagI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = TagI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = TagI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 8; // 8 = TagI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TagI18n object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aTag !== null && $this->id !== $this->aTag->getId()) {
            $this->aTag = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TagI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TagI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TagI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TagI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(TagI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(TagI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(TagI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }
        if ($this->isColumnModified(TagI18nPeer::ACTIVE_LOCALE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TagI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TagI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TagI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TagI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = TagI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TagI18nPeer::ID)) $criteria->add(TagI18nPeer::ID, $this->id);
        if ($this->isColumnModified(TagI18nPeer::LOCALE)) $criteria->add(TagI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(TagI18nPeer::NAME)) $criteria->add(TagI18nPeer::NAME, $this->name);
        if ($this->isColumnModified(TagI18nPeer::SEO_TITLE)) $criteria->add(TagI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(TagI18nPeer::SEO_DESCRIPTION)) $criteria->add(TagI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(TagI18nPeer::SEO_H1)) $criteria->add(TagI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(TagI18nPeer::SEO_KEYWORDS)) $criteria->add(TagI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
        if ($this->isColumnModified(TagI18nPeer::ACTIVE_LOCALE)) $criteria->add(TagI18nPeer::ACTIVE_LOCALE, $this->active_locale);
    ...
    {
        $criteria = new Criteria(TagI18nPeer::DATABASE_NAME);
        $criteria->add(TagI18nPeer::ID, $this->id);
        $criteria->add(TagI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of TagI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TagI18n Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aTag === null && ($this->id !== null) && $doQuery) {
            $this->aTag = TagQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTag->addTagI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(TagI18nPeer::DEFAULT_STRING_FORMAT);
    }
