...
/**
 * Base class that represents a row from the 'newsletter_i18n' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BaseNewsletterI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\NewsletterI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        NewsletterI18nPeer
     */
    ...
    /**
     * Initializes internal state of BaseNewsletterI18n object.
     * @see        applyDefaults()
     */
     ...
     * @return NewsletterI18n The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = NewsletterI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = NewsletterI18nPeer::LOCALE;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = NewsletterI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = NewsletterI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = NewsletterI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = NewsletterI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = NewsletterI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = NewsletterI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating NewsletterI18n object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = NewsletterI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = NewsletterI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                NewsletterI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NewsletterI18nPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(NewsletterI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(NewsletterI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(NewsletterI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(NewsletterI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(NewsletterI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }
        if ($this->isColumnModified(NewsletterI18nPeer::ACTIVE_LOCALE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = NewsletterI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = NewsletterI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $keys = NewsletterI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewsletterI18nPeer::ID)) $criteria->add(NewsletterI18nPeer::ID, $this->id);
        if ($this->isColumnModified(NewsletterI18nPeer::LOCALE)) $criteria->add(NewsletterI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(NewsletterI18nPeer::SEO_TITLE)) $criteria->add(NewsletterI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(NewsletterI18nPeer::SEO_DESCRIPTION)) $criteria->add(NewsletterI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(NewsletterI18nPeer::SEO_H1)) $criteria->add(NewsletterI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(NewsletterI18nPeer::SEO_KEYWORDS)) $criteria->add(NewsletterI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
        if ($this->isColumnModified(NewsletterI18nPeer::ACTIVE_LOCALE)) $criteria->add(NewsletterI18nPeer::ACTIVE_LOCALE, $this->active_locale);
    ...
    {
        $criteria = new Criteria(NewsletterI18nPeer::DATABASE_NAME);
        $criteria->add(NewsletterI18nPeer::ID, $this->id);
        $criteria->add(NewsletterI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of NewsletterI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return NewsletterI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return NewsletterI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new NewsletterI18nPeer();
        }
    ...
    {
        if ($this->aNewsletter === null && ($this->id !== null) && $doQuery) {
            $this->aNewsletter = NewsletterQuery::create()->findPk($this->id, $con);
    ...
    {
        return (string) $this->exportTo(NewsletterI18nPeer::DEFAULT_STRING_FORMAT);
    }
