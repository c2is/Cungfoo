...
abstract class BaseVilleI18nQuery extends ModelCriteria
{
    ...
    public function filterBySeoTitle($seoTitle = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(VilleI18nPeer::SEO_TITLE, $seoTitle, $comparison);
    }
    ...
    public function filterBySeoDescription($seoDescription = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(VilleI18nPeer::SEO_DESCRIPTION, $seoDescription, $comparison);
    }
    ...
    public function filterBySeoH1($seoH1 = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(VilleI18nPeer::SEO_H1, $seoH1, $comparison);
    }
