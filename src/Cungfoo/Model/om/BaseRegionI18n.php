...
abstract class BaseRegionI18n extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\RegionI18nPeer';
    ...
    /**
     * Initializes internal state of BaseRegionI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = RegionI18nPeer::LOCALE;
        }
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = RegionI18nPeer::SLUG;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = RegionI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = RegionI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = RegionI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = RegionI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = RegionI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 11; // 11 = RegionI18nPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RegionI18nQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RegionI18nPeer::SLUG)) {
        ...
        if ($this->isColumnModified(RegionI18nPeer::SEO_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`seo_title`';
        }
        if ($this->isColumnModified(RegionI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(RegionI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(RegionI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }
        if ($this->isColumnModified(RegionI18nPeer::ACTIVE_LOCALE)) {
    ...
    {
        if (isset($alreadyDumpedObjects['RegionI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RegionI18n'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RegionI18nPeer::SLUG)) $criteria->add(RegionI18nPeer::SLUG, $this->slug);
        ...
        if ($this->isColumnModified(RegionI18nPeer::SEO_TITLE)) $criteria->add(RegionI18nPeer::SEO_TITLE, $this->seo_title);
        if ($this->isColumnModified(RegionI18nPeer::SEO_DESCRIPTION)) $criteria->add(RegionI18nPeer::SEO_DESCRIPTION, $this->seo_description);
        if ($this->isColumnModified(RegionI18nPeer::SEO_H1)) $criteria->add(RegionI18nPeer::SEO_H1, $this->seo_h1);
        if ($this->isColumnModified(RegionI18nPeer::SEO_KEYWORDS)) $criteria->add(RegionI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
        if ($this->isColumnModified(RegionI18nPeer::ACTIVE_LOCALE)) $criteria->add(RegionI18nPeer::ACTIVE_LOCALE, $this->active_locale);
    ...
    public function buildPkeyCriteria()
    {
        ...
        $criteria->add(RegionI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of RegionI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RegionI18n Clone of current object.
     * @throws PropelException
     */
    ...
    public function getRegion(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRegion === null && ($this->id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aRegion->addRegionI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(RegionI18nPeer::DEFAULT_STRING_FORMAT);
    }
