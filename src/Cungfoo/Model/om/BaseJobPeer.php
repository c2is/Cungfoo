...
use Cungfoo\Model\map\JobTableMap;
...
abstract class BaseJobPeer
{
    ...
    const OM_CLASS = 'Cungfoo\\Model\\Job';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Type', 'Params', 'Message', 'CompletedAt', 'Status', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'type', 'params', 'message', 'completedAt', 'status', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (JobPeer::ID, JobPeer::NAME, JobPeer::TYPE, JobPeer::PARAMS, JobPeer::MESSAGE, JobPeer::COMPLETED_AT, JobPeer::STATUS, JobPeer::CREATED_AT, JobPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'TYPE', 'PARAMS', 'MESSAGE', 'COMPLETED_AT', 'STATUS', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'type', 'params', 'message', 'completed_at', 'status', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Type' => 2, 'Params' => 3, 'Message' => 4, 'CompletedAt' => 5, 'Status' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'type' => 2, 'params' => 3, 'message' => 4, 'completedAt' => 5, 'status' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        BasePeer::TYPE_COLNAME => array (JobPeer::ID => 0, JobPeer::NAME => 1, JobPeer::TYPE => 2, JobPeer::PARAMS => 3, JobPeer::MESSAGE => 4, JobPeer::COMPLETED_AT => 5, JobPeer::STATUS => 6, JobPeer::CREATED_AT => 7, JobPeer::UPDATED_AT => 8, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'TYPE' => 2, 'PARAMS' => 3, 'MESSAGE' => 4, 'COMPLETED_AT' => 5, 'STATUS' => 6, 'CREATED_AT' => 7, 'UPDATED_AT' => 8, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'type' => 2, 'params' => 3, 'message' => 4, 'completed_at' => 5, 'status' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
