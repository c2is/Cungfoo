...
/**
 * Base class that represents a row from the 'portfolio_media_i18n' table.
 *
 *
 *
 * @package    propel.generator.Cungfoo.Model.om
 */
abstract class BasePortfolioMediaI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Cungfoo\\Model\\PortfolioMediaI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PortfolioMediaI18nPeer
     */
    ...
    /**
     * Initializes internal state of BasePortfolioMediaI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PortfolioMediaI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = PortfolioMediaI18nPeer::LOCALE;
        }
    ...
    public function setSeoTitle($v)
    {
        ...
        if ($this->seo_title !== $v) {
            $this->seo_title = $v;
            $this->modifiedColumns[] = PortfolioMediaI18nPeer::SEO_TITLE;
        }
    ...
    public function setSeoDescription($v)
    {
        ...
        if ($this->seo_description !== $v) {
            ...
            $this->modifiedColumns[] = PortfolioMediaI18nPeer::SEO_DESCRIPTION;
        }
    ...
    public function setSeoH1($v)
    {
        ...
        if ($this->seo_h1 !== $v) {
            $this->seo_h1 = $v;
            $this->modifiedColumns[] = PortfolioMediaI18nPeer::SEO_H1;
        }
    ...
    public function setSeoKeywords($v)
    {
        ...
        if ($this->seo_keywords !== $v) {
            $this->seo_keywords = $v;
            $this->modifiedColumns[] = PortfolioMediaI18nPeer::SEO_KEYWORDS;
        }
    ...
    public function setActiveLocale($v)
    {
        ...
        if ($this->active_locale !== $v) {
            ...
            $this->modifiedColumns[] = PortfolioMediaI18nPeer::ACTIVE_LOCALE;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPortfolioMedia !== null && $this->id !== $this->aPortfolioMedia->getId()) {
            $this->aPortfolioMedia = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PortfolioMediaI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PortfolioMediaI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PortfolioMediaI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PortfolioMediaI18nPeer::ID)) {
        ...
        if ($this->isColumnModified(PortfolioMediaI18nPeer::SEO_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`seo_description`';
        }
        if ($this->isColumnModified(PortfolioMediaI18nPeer::SEO_H1)) {
            $modifiedColumns[':p' . $index++]  = '`seo_h1`';
        }
        if ($this->isColumnModified(PortfolioMediaI18nPeer::SEO_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = '`seo_keywords`';
        }
        if ($this->isColumnModified(PortfolioMediaI18nPeer::ACTIVE_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`active_locale`';
        }

        $sql = sprintf(
            'INSERT INTO `portfolio_media_i18n` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PortfolioMediaI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PortfolioMediaI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PortfolioMediaI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PortfolioMediaI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = PortfolioMediaI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PortfolioMediaI18nPeer::SEO_KEYWORDS)) $criteria->add(PortfolioMediaI18nPeer::SEO_KEYWORDS, $this->seo_keywords);
        if ($this->isColumnModified(PortfolioMediaI18nPeer::ACTIVE_LOCALE)) $criteria->add(PortfolioMediaI18nPeer::ACTIVE_LOCALE, $this->active_locale);
    ...
    {
        $criteria = new Criteria(PortfolioMediaI18nPeer::DATABASE_NAME);
        $criteria->add(PortfolioMediaI18nPeer::ID, $this->id);
        $criteria->add(PortfolioMediaI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of PortfolioMediaI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PortfolioMediaI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PortfolioMediaI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PortfolioMediaI18nPeer();
        }
    ...
    {
        if ($this->aPortfolioMedia === null && ($this->id !== null) && $doQuery) {
            $this->aPortfolioMedia = PortfolioMediaQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPortfolioMedia->addPortfolioMediaI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PortfolioMediaI18nPeer::DEFAULT_STRING_FORMAT);
    }
