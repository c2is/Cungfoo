...
/**
 * This class defines the structure of the 'portfolio_tag_i18n' table.
 *
 *
 *
 ...
 */
class PortfolioTagI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Cungfoo.Model.map.PortfolioTagI18nTableMap';
    ...
    {
        // attributes
        $this->setName('portfolio_tag_i18n');
        $this->setPhpName('PortfolioTagI18n');
        $this->setClassname('Cungfoo\\Model\\PortfolioTagI18n');
    ...
    {
        $this->addRelation('PortfolioTag', 'Cungfoo\\Model\\PortfolioTag', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()

} // PortfolioTagI18nTableMap
