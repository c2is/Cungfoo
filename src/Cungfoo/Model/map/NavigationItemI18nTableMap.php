...
/**
 * This class defines the structure of the 'navigation_item_i18n' table.
 *
 *
 *
 ...
 */
class NavigationItemI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Cungfoo.Model.map.NavigationItemI18nTableMap';
    ...
    {
        // attributes
        $this->setName('navigation_item_i18n');
        $this->setPhpName('NavigationItemI18n');
        $this->setClassname('Cungfoo\\Model\\NavigationItemI18n');
    ...
    {
        $this->addRelation('NavigationItem', 'Cungfoo\\Model\\NavigationItem', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()

} // NavigationItemI18nTableMap
