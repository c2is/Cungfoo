...
/**
 * This class defines the structure of the 'portfolio_media_i18n' table.
 *
 *
 *
 ...
 */
class PortfolioMediaI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Cungfoo.Model.map.PortfolioMediaI18nTableMap';
    ...
    {
        // attributes
        $this->setName('portfolio_media_i18n');
        $this->setPhpName('PortfolioMediaI18n');
        $this->setClassname('Cungfoo\\Model\\PortfolioMediaI18n');
    ...
    {
        $this->addRelation('PortfolioMedia', 'Cungfoo\\Model\\PortfolioMedia', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()

} // PortfolioMediaI18nTableMap
