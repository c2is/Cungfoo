...
/**
 * This class defines the structure of the 'camping_activite' table.
 *
 *
 *
 ...
 */
class CampingActiviteTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Cungfoo.Model.map.CampingActiviteTableMap';
    ...
    {
        // attributes
        $this->setName('camping_activite');
        $this->setPhpName('CampingActivite');
        $this->setClassname('Cungfoo\\Model\\CampingActivite');
        $this->setPackage('Cungfoo.Model');
        $this->setUseIdGenerator(false);
        $this->setIsCrossRef(true);
        // columns
        $this->addForeignPrimaryKey('CAMPING_ID', 'CampingId', 'INTEGER' , 'camping', 'ID', true, null, null);
        $this->addForeignPrimaryKey('ACTIVITE_ID', 'ActiviteId', 'VARCHAR' , 'activite', 'ID', true, 255, null);
        // validators
    } // initialize()
