...
class EventI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Cungfoo.Model.map.EventI18nTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Cungfoo\\Model\\EventI18n');
        ...
        $this->addColumn('STR_DATE', 'StrDate', 'VARCHAR', true, 255, null);
        // validators
    } // initialize()
    ...
    {
        $this->addRelation('Event', 'Cungfoo\\Model\\Event', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
