...
/**
 * This class defines the structure of the 'camping_i18n' table.
 *
 *
 *
 ...
 */
class CampingI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Cungfoo.Model.map.CampingI18nTableMap';
    ...
    {
        // attributes
        $this->setName('camping_i18n');
        $this->setPhpName('CampingI18n');
        $this->setClassname('Cungfoo\\Model\\CampingI18n');
    ...
    {
        $this->addRelation('Camping', 'Cungfoo\\Model\\Camping', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
