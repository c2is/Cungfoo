...
/**
 * This class defines the structure of the 'camping_equipement' table.
 *
 *
 *
 ...
 */
class CampingEquipementTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Cungfoo.Model.map.CampingEquipementTableMap';
    ...
    {
        // attributes
        $this->setName('camping_equipement');
        $this->setPhpName('CampingEquipement');
        $this->setClassname('Cungfoo\\Model\\CampingEquipement');
        $this->setPackage('Cungfoo.Model');
        $this->setUseIdGenerator(false);
        $this->setIsCrossRef(true);
        // columns
        $this->addForeignPrimaryKey('CAMPING_ID', 'CampingId', 'INTEGER' , 'camping', 'ID', true, null, null);
        $this->addForeignPrimaryKey('EQUIPEMENT_ID', 'EquipementId', 'VARCHAR' , 'equipement', 'ID', true, 255, null);
        // validators
    } // initialize()
