...
/**
 * This class defines the structure of the 'departement_i18n' table.
 *
 *
 *
 ...
 */
class DepartementI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Cungfoo.Model.map.DepartementI18nTableMap';
    ...
    {
        // attributes
        $this->setName('departement_i18n');
        $this->setPhpName('DepartementI18n');
        $this->setClassname('Cungfoo\\Model\\DepartementI18n');
        $this->setPackage('Cungfoo.Model');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id', 'Id', 'INTEGER' , 'departement', 'id', true, null, null);
    ...
    {
        $this->addRelation('Departement', 'Cungfoo\\Model\\Departement', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()

} // DepartementI18nTableMap
