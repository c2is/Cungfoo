...
class NewsletterTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Cungfoo.Model.map.NewsletterTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Cungfoo\\Model\\Newsletter');
    ...
    {
        $this->addRelation('NewsletterI18n', 'Cungfoo\\Model\\NewsletterI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'CASCADE', null, 'NewsletterI18ns');
    } // buildRelations()
  ...
  'active_locale_column' => 'active_locale',
            ...
            'crudable' =>  array (
  'route_prefix' => '/',
  'crud_prefix' => '/coordonnees/newsletters',
  'crud_model' => NULL,
  'crud_form' => NULL,
  'crud_type_file' => NULL,
  'crud_search' => 'email',
