...
class PortfolioMediaTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('NAME_ORIGIN', 'NameOrigin', 'VARCHAR', false, 255, null);
        $this->addColumn('NAME', 'Name', 'VARCHAR', false, 255, null);
        $this->addColumn('DESCRIPTION', 'Description', 'LONGVARCHAR', false, null, null);
        $this->addColumn('PATH_ORIGIN', 'PathOrigin', 'VARCHAR', false, 255, null);
        $this->addColumn('PATH_MINIATURE', 'PathMiniature', 'VARCHAR', false, 255, null);
