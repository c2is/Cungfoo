...
/**
 * This class defines the structure of the 'thematique_i18n' table.
 *
 *
 *
 ...
 */
class ThematiqueI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Cungfoo.Model.map.ThematiqueI18nTableMap';
    ...
    {
        // attributes
        $this->setName('thematique_i18n');
        $this->setPhpName('ThematiqueI18n');
        $this->setClassname('Cungfoo\\Model\\ThematiqueI18n');
