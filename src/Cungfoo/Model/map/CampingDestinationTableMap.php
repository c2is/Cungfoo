...
/**
 * This class defines the structure of the 'camping_destination' table.
 *
 *
 *
 ...
 */
class CampingDestinationTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Cungfoo.Model.map.CampingDestinationTableMap';
    ...
    {
        // attributes
        $this->setName('camping_destination');
        $this->setPhpName('CampingDestination');
        $this->setClassname('Cungfoo\\Model\\CampingDestination');
