...
{
    const HANDLER_CLASS  = '\Cungfoo\Lib\Job\%sJobHandler';
    ...
    protected static $labelTypeJob = array(
        'ResalysLoad' => 'Chargement des données Resalys'
    );
    ...
    public function run($params)
    {
        ...
        $jobClass   = sprintf(self::HANDLER_CLASS, ucfirst($this->getType()));
