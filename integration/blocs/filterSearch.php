<form action="" class="formSearchRefined" id="formSearchRefined">

    <p class="title">Affinez votre recherche</p>
    <p class="criteres"><span id="nbCrit">0</span> critère(s) séléctioné(s)</p>

    <!-- situation -->
        <p class="sectionTitle">Situation</p>
    ...
    <!-- destinations mmv -->
        <p class="sectionTitle">Destinations mmv</p>
    ...
    <!-- formules mmv -->
        <p class="sectionTitle">Formules mmv</p>
    ...
    <!-- services -->
        <p class="sectionTitle">Services</p>
    ...
    <!-- animations et loisirs -->
        <p class="sectionTitle">Animations et loisirs</p>
    ...
    <!-- services a la carte -->
        <p class="sectionTitle">Services à la carte</p>
    ...
    <!-- submit rechercher -->
    <button class="bt sombre searchGlobalSubmit">Filtrer</button>
</form>