<?php
    ...
    <!-- colonne full -->
        <div class="column clearboth clear">
            ...
            <div id="bpItemsList" class="clear">
                <div class="bpItem itemResult bgImg">
                    ...
                    <div class="content clear">
                        ...
                        <div class="stain fushia cover linkBlock" href="#" style="background-size: cover;">
                        <span>
                            à partir de<br>
                            <span class="price linkBlock">244<span class="fine">&nbsp;</span>€</span>
                            la semaine
                        </span>
                        </div>
                        <a href="#" class="bt fushia big ib right popinBP">Voir l'offre</a>
                    </div>
                </div>
