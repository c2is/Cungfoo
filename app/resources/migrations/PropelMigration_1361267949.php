 ...
 * up to version 1361267949.
 * Generated on 2013-02-19 10:59:09 by m.brunot
 */
class PropelMigration_1361267949
{
...
CREATE INDEX `etablissement_FI_4` ON `etablissement` (`related_1`);

CREATE INDEX `etablissement_FI_5` ON `etablissement` (`related_2`);
...
DROP INDEX `etablissement_FI_5` ON `etablissement`;
