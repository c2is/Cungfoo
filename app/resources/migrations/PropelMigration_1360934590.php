...
INSERT INTO seo_i18n (id, locale, seo_title, seo_description, seo_h1, seo_keywords) VALUES (3, \'de\', \'Location mobil home %departement% pas cher, camping %departement%\', \'Réserver en ligne vos futures vacances dans le département %departement% en %pays% avec Vacances directes (location de mobil-homes pas cher en camping).\', \'Location mobil home %item%\', \'\');
